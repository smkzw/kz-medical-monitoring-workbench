...
# R1 is read-only source code for this adapter.  Keep the same import seam as
# runtime_progress so both the POC test runner and product package can import
# this module without installing a package.
...
from mm_r1.capability_runtime import InvocationVersions  # noqa: E402
from mm_r1.controller import CapabilityWorkUnitController  # noqa: E402
