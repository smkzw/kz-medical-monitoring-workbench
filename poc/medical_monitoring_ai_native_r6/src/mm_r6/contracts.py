...
#: Workbench repository root (four levels above this file's directory chain:
#: ``workbench/poc/medical_monitoring_ai_native_r6/src/mm_r6/contracts.py``).
WORKBENCH_ROOT: Path = Path(__file__).resolve().parents[4]
