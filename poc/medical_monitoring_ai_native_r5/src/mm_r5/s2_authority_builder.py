...
from mm_r4.d10_evaluator import D10RunResult, evaluate
...
from mm_r5.authority_adapter import (
    DEFAULT_D10_AUTHORITY_ADAPTER_VARIANT,
    build_authority_receipt,
)
from mm_r5.contracts import R5AuthorityReceipt
from mm_r5.s2_contracts import (
    AUTHORITY_MODE_S2,
    STAGE_STATUS_S2,
    R5S2AuthorityPacket,
    R5S2CenterBinding,
