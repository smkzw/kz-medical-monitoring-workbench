...
// medicalMonitoringR7ContinuityPanelRender.test.mjs via esbuild so the
...
import { MedicalMonitoringR7ContinuityPanel } from "./MedicalMonitoringR7ContinuityPanel.jsx";
import {
...
export const renders = {
  loading: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel loading continuity={null} />,
  ),
  unavailableDefault: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={null} />,
  ),
  unavailableCustom: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={null} unavailable="自定义错误提示" />,
  ),
  unavailableWins: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={readyContinuity} unavailable="自定义错误提示" resultPayload={RESULT_PAYLOAD} />,
  ),
  ready: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={readyContinuity} resultPayload={RESULT_PAYLOAD} onJourney={() => {}} onSource={() => {}} />,
  ),
  readyFirstAnalysis: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={readyFirstAnalysis} resultPayload={RESULT_PAYLOAD} />,
  ),
  empty: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={emptyContinuity} resultPayload={RESULT_PAYLOAD} />,
  ),
  truncated: renderToStaticMarkup(
    <MedicalMonitoringR7ContinuityPanel continuity={truncatedContinuity} resultPayload={RESULT_PAYLOAD} />,
  ),
};
