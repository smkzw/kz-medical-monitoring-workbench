...
import "./medicalMonitoringR7ProgressPanel.css";
...
export function MedicalMonitoringR7ProgressPanel({ routeCanonical, api }) {
...
export default MedicalMonitoringR7ProgressPanel;
