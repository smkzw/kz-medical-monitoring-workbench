...
buildSync({
  entryPoints: [path.join(here, "medicalMonitoringR5SubjectFlowRender.test.jsx")],
  bundle: true,
  outfile: bundlePath,
  format: "cjs",
  platform: "node",
...
const css = fs.readFileSync(path.join(here, "medicalMonitoringR5.css"), "utf8");
...
console.log(`medicalMonitoringR5SubjectFlowRender: ${passed} checks passed`);
