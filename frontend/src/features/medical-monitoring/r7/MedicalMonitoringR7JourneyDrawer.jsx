...
import { R7_JOURNEY_DRAWER_SECTION_ORDER } from "./medicalMonitoringR7JourneyChanges.mjs";
import {
...
import "./medicalMonitoringR7JourneyDrawer.css";
 ...
 */
export function MedicalMonitoringR7JourneyDrawer({
  mode = "overlay",
  sections = null,
  changeRows = [],
  currentRowIndex = -1,
...
export default MedicalMonitoringR7JourneyDrawer;
