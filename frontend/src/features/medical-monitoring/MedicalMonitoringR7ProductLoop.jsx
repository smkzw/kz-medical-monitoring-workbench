...
} from "./medicalMonitoringR7ProductApi.mjs";
import {
  projectR7History,
...
import { r7JourneyDrawerClosePatch } from "./medicalMonitoringR7JourneyChanges.mjs";
...
export function MedicalMonitoringR7ProductLoop({
  projectId,
  route = {},
  onRouteChange,
  onReturn,
      ...
      {!loadingBody && !resultError && !setupHistoryError && resultLoaded ? (
        <div className="r7-product-result-body">
          ...
          {suppressVersionClaim && (routeView === "overview" || routeView === "site_overview") ? (
            <MedicalMonitoringR7ContinuityPanel
...
export default MedicalMonitoringR7ProductLoop;
