# Conference Context: mm_r7_slice_05_background_recovery_contract_20260828

Created: 2026-08-28 09:39:56
...
- Linked execution task: `mm_r7_slice_05_background_recovery_contract_20260828`
...
- `context/medical_monitoring_r7_slice_05_background_recovery_contract_draft_20260828.md`
...
- `poc/medical_monitoring_ai_native_r1/src/mm_r1/store.py`（capability lease、checkpoint、recover）
...
- `reviews/medical_monitoring_ai_native_system_design_v1_20260809.md` §§12,15。

## Scope

- In scope: 草案逐条反例审查、R1 能力复用边界、最小可实现状态机与验收矩阵修订建议。
- Out of scope: 修改代码/草案、启动线程或服务、模型/真实项目、前端/视觉、医学写作、安全扩展。
...
- 只读授权工作台；Codex retains final acceptance.
...
- 2026-08-28 09:39:56: Conference initialized by `hermes_workflow_guard.py init-conference`.
