# Task Context: medical_monitoring_p5

Created: 2026-07-29 13:36:37
Objective: 构建统一医学风险工作台：稳定风险身份、七列Checklist、未读/处置分离、证据正文优先、跨视图定位和真实项目LOOP
...
- 2026-07-29 13:36:37: Task initialized by `tools/hermes_workflow_guard.py init-task`.
