# Codex Main-Venue Plan: mm_r5_s7_cursor_grok_visual_recheck_20260827
...
|---|---|---|---|
| `visual_pi_k3_256k` | `cursor`（用户显式覆盖） | `cursor-grok-4.6:high` | `runs/conference/mm_r5_s7_cursor_grok_visual_recheck_20260827/visual_pi_k3_256k.md` |
