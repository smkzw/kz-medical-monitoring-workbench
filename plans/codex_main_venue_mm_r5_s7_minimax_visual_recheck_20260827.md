# Codex Main-Venue Plan: mm_r5_s7_minimax_visual_recheck_20260827
...
|---|---|---|---|
| `visual_pi_k3_256k` | `cms-router`（用户显式覆盖） | `minimax-m3:high` | `runs/conference/mm_r5_s7_minimax_visual_recheck_20260827/visual_pi_k3_256k.md` |
