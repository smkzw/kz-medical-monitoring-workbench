...
def _builtin_profiles() -> tuple[AiProviderProfile, ...]:
    return (
        ...
        AiProviderProfile(
            profile_id=MONITORING_C3_CMS_PRIMARY_PROFILE_ID,
            provider=MONITORING_C3_CMS_PRIMARY_PROVIDER,
            label="MiniMax M3 医学监查主分析（历史）",
            base_url=CMS_SMK_BASE_URL,
            model=MONITORING_C3_CMS_PRIMARY_MODEL,
            expected_response_model=MONITORING_C3_CMS_PRIMARY_MODEL,
