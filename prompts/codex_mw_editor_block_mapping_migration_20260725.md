...
- Runner-managed output path: `runs/codex_mw_editor_block_mapping_migration_20260725.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: mw_editor_block_mapping_migration_20260725`
2. `## Boundary Check`
3. `## Direct Work`
