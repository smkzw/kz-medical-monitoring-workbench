...
- Runner-managed output path: `runs/pi_medical_monitoring_p9_rule_source_hash_exact_20260805.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_p9_rule_source_hash_exact_20260805_context.md`
...
Output schema:
1. `# Hermes Task Plan: medical_monitoring_p9_rule_source_hash_exact_20260805`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
