...
- Runner-managed output path: `runs/codex_monitoring_record_rule_mapping_p7b.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/monitoring_record_rule_mapping_p7b_context.md`
...
Output schema:
1. `# Codex Direct Task: monitoring_record_rule_mapping_p7b`
2. `## Boundary Check`
3. `## Direct Work`
