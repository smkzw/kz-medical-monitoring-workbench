...
- Runner-managed output path: `runs/codex_monitoring_p10_v10_zero_submit_gate_20260801.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: monitoring_p10_v10_zero_submit_gate_20260801`
2. `## Boundary Check`
3. `## Direct Work`
