...
- Write exactly one output file: `runs/hermes_mw_cross_indication_reference_release_gate_20260718.md`.
...
Output schema:
1. `# Hermes Task Plan: mw_cross_indication_reference_release_gate_20260718`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
