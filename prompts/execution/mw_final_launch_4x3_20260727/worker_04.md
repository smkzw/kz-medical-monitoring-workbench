...
- Runner-managed report path: `runs/execution/mw_final_launch_4x3_20260727/worker_04.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Tester D: pi/google-antigravity/gemini-3.6-flash high完成D1-D3双视角真实页面LOOP
...
Output schema:
1. `# Execution Output: mw_final_launch_4x3_20260727 - worker_04`
