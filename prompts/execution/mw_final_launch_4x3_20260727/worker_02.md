...
- Runner-managed report path: `runs/execution/mw_final_launch_4x3_20260727/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Tester B: pi/aishuo/cms-model 在非禁用窗口完成B1-B3双视角真实页面LOOP
...
Output schema:
1. `# Execution Output: mw_final_launch_4x3_20260727 - worker_02`
