...
- Runner-managed report path: `runs/execution/mw_final_launch_4x3_20260727/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Tester A: pi/alibaba/qwen3.8-max-preview 在夜间优先窗口完成A1-A3双视角真实页面LOOP
...
Output schema:
1. `# Execution Output: mw_final_launch_4x3_20260727 - worker_01`
