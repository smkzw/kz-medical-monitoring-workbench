...
- Runner-managed report path: `runs/execution/mw_final_launch_4x3_20260727/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Tester C: codebuddy cli/hy3 完成C1-C3双视角真实页面LOOP
...
Output schema:
1. `# Execution Output: mw_final_launch_4x3_20260727 - worker_03`
