...
- Write exactly one output file: `runs/execution/mw_intervention_rules_discovery_20260717/manager.md`. This is the execution report; the runner persists the final response there. Do not create sibling process files.
...
- `runs/execution/mw_intervention_rules_discovery_20260717/worker_01.md`
- `runs/execution/mw_intervention_rules_discovery_20260717/worker_02.md`
- `runs/execution/mw_intervention_rules_discovery_20260717/worker_03.md`
...
Output schema:
1. `# Execution Output: mw_intervention_rules_discovery_20260717 - complex_manager_grok`
