...
- Task id: `monitoring_p10_v11_datagap_semantic_corrective_20260801`
...
- Runner-managed report path: `runs/execution/monitoring_p10_v11_datagap_semantic_corrective_20260801/manager.md`. Never invoke write/edit tools
...
Initial read set:
- `AGENTS.md`
- `context/monitoring_p10_v11_datagap_semantic_corrective_20260801_execution_context.md`
- `plans/codex_execution_monitoring_p10_v11_datagap_semantic_corrective_20260801.md`
- `runs/execution/monitoring_p10_v11_datagap_semantic_corrective_20260801/worker_01.md`
- `runs/execution/monitoring_p10_v11_datagap_semantic_corrective_20260801/worker_02.md`
- `runs/execution/monitoring_p10_v11_datagap_semantic_corrective_20260801/worker_03.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
Implement the offline v11 DATA_GAP semantic-family corrective, audit trace, frozen v10 cutover, and focused regressions without any runtime or provider call
...
Output schema:
1. `# Execution Output: monitoring_p10_v11_datagap_semantic_corrective_20260801 - finite_code_manager_cursor`
