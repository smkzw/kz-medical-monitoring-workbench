...
- Runner-managed report path: `runs/execution/mm_r5_s5_public_authority_producers_20260825/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Implement the three production modules and runtime fixtures on the exact accepted create-only paths, using stdlib-first immutable dataclasses and accepted recipe/typed authority only.
...
Output schema:
1. `# Execution Output: mm_r5_s5_public_authority_producers_20260825 - worker_01`
