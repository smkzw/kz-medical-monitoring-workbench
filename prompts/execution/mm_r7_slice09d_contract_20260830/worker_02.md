...
- Runner-managed report path: `runs/execution/mm_r7_slice09d_contract_20260830/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 审阅长任务、恢复、备份/迁移/审计链与技术日志实现，提出进程中断、重启、资源压力、幂等、恢复时间和数据完整性的故障/恢复矩阵及中文用户结果，保持 stdlib-first 与离线边界。
...
Output schema:
1. `# Execution Output: mm_r7_slice09d_contract_20260830 - worker_02`
