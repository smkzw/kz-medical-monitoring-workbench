...
- Runner-managed report path: `runs/execution/mm_r7_slice09d_contract_20260830/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 审阅既有 Slice-08/09、R5-S6/S7 性能证据与当前代码，提出 09D 分级 synthetic corpus、指标、采样、冷暖运行、容量台阶和停止条件；不得把单机历史数值直接变成普适 SLO。
...
Output schema:
1. `# Execution Output: mm_r7_slice09d_contract_20260830 - worker_01`
