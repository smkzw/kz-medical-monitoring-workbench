...
- Runner-managed report path: `runs/execution/mw-literature-word-link-release-exec/manager.md`. Never invoke write/edit tools
...
- `runs/execution/mw-literature-word-link-release-exec/worker_01.md`
- `runs/execution/mw-literature-word-link-release-exec/worker_02.md`
...
Output schema:
1. `# Execution Output: mw-literature-word-link-release-exec - complex_manager_grok`
