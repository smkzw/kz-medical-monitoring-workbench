...
- Runner-managed report path: `runs/execution/mm_r5_s5_subject_workspace_runtime_v0_1_20260826/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Implement s5_contracts.py, s5_authority_adapter.py, s5_projection.py, s5_validator.py, and synthetic runtime fixtures strictly from the accepted contract and exact allowlist.
...
Output schema:
1. `# Execution Output: mm_r5_s5_subject_workspace_runtime_v0_1_20260826 - worker_01`
