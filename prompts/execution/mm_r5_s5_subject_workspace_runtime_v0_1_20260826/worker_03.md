...
- Runner-managed report path: `runs/execution/mm_r5_s5_subject_workspace_runtime_v0_1_20260826/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Independently audit the entire eleven-path runtime surface, run normal/-O/-OO focused and adjacent regressions, verify hashes/boundaries, and report accept-or-revise without modifying files.
...
Output schema:
1. `# Execution Output: mm_r5_s5_subject_workspace_runtime_v0_1_20260826 - worker_03`
