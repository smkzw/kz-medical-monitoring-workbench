...
- Runner-managed report path: `runs/execution/mm_r7_slice07b_subject_flow_implementation_20260828/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 前端数据与路由：严格规范化 subject_flow 三种形态，加入互斥 flow route keys、Journey 往返保留和 adapter/route tests。只改 frontend/src/features/medical-monitoring/r5 的 adapter、route-state 和对应测试，不改页面/CSS。
...
Output schema:
1. `# Execution Output: mm_r7_slice07b_subject_flow_implementation_20260828 - worker_02`
