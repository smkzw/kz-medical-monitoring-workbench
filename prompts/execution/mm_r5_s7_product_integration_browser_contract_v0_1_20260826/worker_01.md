...
- Runner-managed report path: `runs/execution/mm_r5_s7_product_integration_browser_contract_v0_1_20260826/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 合同架构：读取R5 v0.3、S5/S6 accepted evidence、现有产品医学监查入口，产出精确product allowlist、只读API/adapter边界、迁移/回滚/身份/医学写作保护合同。
...
Output schema:
1. `# Execution Output: mm_r5_s7_product_integration_browser_contract_v0_1_20260826 - worker_01`
