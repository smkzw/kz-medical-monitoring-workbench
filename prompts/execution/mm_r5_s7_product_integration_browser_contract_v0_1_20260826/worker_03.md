...
- Runner-managed report path: `runs/execution/mm_r5_s7_product_integration_browser_contract_v0_1_20260826/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 独立验证：机械核验合同闭合、路径与哈希、8911停止、禁止越界、后续视觉execution与独立visual conference分离，输出唯一ACCEPT或REVISE裁决。
...
Output schema:
1. `# Execution Output: mm_r5_s7_product_integration_browser_contract_v0_1_20260826 - worker_03`
