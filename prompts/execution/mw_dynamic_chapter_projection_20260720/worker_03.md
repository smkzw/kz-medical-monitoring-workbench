...
- Runner-managed report path: `runs/execution/mw_dynamic_chapter_projection_20260720/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 对D017、RA、RUX三类研究定义做跨项目边缘案例测试，验证不适用/未知条件模块不产生空章节且必需章节有显式待补事实状态
...
Output schema:
1. `# Execution Output: mw_dynamic_chapter_projection_20260720 - worker_03`
