...
- Runner-managed report path: `runs/execution/mw_dynamic_chapter_projection_20260720/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 审计公司方案模板节点与StudyDefinition字段，提出通用语义投影矩阵和必需/条件/不适用/未知章节规则
...
Output schema:
1. `# Execution Output: mw_dynamic_chapter_projection_20260720 - worker_01`
