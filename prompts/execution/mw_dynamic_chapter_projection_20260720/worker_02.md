...
- Runner-managed report path: `runs/execution/mw_dynamic_chapter_projection_20260720/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现并测试已确认项目事实到章节正文初稿的确定性投影，严格限制写集为medical_writing_protocol_template.py及其专项测试
...
Output schema:
1. `# Execution Output: mw_dynamic_chapter_projection_20260720 - worker_02`
