...
- Runner-managed report path: `runs/execution/mw_final_release_matrix_20260727/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: DOCX精确导出门：封面、目录跳转、标题样式、字体、摘要嵌套表、图表量表、引用与Word实际打开。
...
Output schema:
1. `# Execution Output: mw_final_release_matrix_20260727 - worker_02`
