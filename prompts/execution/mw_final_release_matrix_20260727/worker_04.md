...
- Runner-managed report path: `runs/execution/mw_final_release_matrix_20260727/worker_04.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: CodeBuddy Hy3 和 Cursor composer-2.5 两条真实浏览器三适应症测试通道。
...
Output schema:
1. `# Execution Output: mw_final_release_matrix_20260727 - worker_04`
