...
- Runner-managed report path: `runs/execution/mm_r5_s7_visual_findings_repair_20260827/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 独立验证：只读核验前两项当前bytes，运行R5聚焦及相邻测试、production build、禁止词/GET-only/医学写作542文件摘要/8911和5174停止检查；输出ACCEPT或REVISE，不修改源码。
...
Output schema:
1. `# Execution Output: mm_r5_s7_visual_findings_repair_20260827 - worker_03`
