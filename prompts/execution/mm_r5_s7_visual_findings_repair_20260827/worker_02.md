...
- Runner-managed report path: `runs/execution/mm_r5_s7_visual_findings_repair_20260827/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 前端体验：仅修改frontend/src/features/medical-monitoring/r5/MedicalMonitoringR5Page.jsx、medicalMonitoringR5.css及同目录现有R5测试；实现八域分轨展示与+/-/0键盘及可见按钮语义缩放、身份条从canonical route回填项目/批次/版本、来源页展示原始定位/记录号/引文；保持中文原生与GET-only。
...
Output schema:
1. `# Execution Output: mm_r5_s7_visual_findings_repair_20260827 - worker_02`
