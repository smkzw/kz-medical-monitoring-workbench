...
- Runner-managed report path: `runs/execution/mw_ai_first_prefill_postchallenge2_corrective_20260801/manager.md`. Never invoke write/edit tools
...
- `runs/execution/mw_ai_first_prefill_postchallenge2_corrective_20260801/worker_03.md`
...
Workers execute serially in one shared tree. Treat their reports as claims:
inspect the final source for all P2-P4 contracts, ensure later edits did not
erase earlier ones, run the complete focused 601-test authoring suite plus
declared frontend checks, and map every success criterion to direct evidence.
Return a precise same-session rerun request for any missing contract. Do not
start services or a browser.
...
Output schema:
1. `# Execution Output: mw_ai_first_prefill_postchallenge2_corrective_20260801 - finite_code_manager_cursor`
