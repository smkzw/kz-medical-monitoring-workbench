...
- Runner-managed report path: `runs/execution/mm_r5_s7_product_integration_runtime_v0_1_20260826/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 独立验证：后端/前端合并后机械检查exact allowlist、医学写作inventory、8911/5174停止、GET-only/no-fallback、中文禁词、S5/S6 identity、聚焦/相邻测试与production build，输出ACCEPT或REVISE；不得改源码。
...
Output schema:
1. `# Execution Output: mm_r5_s7_product_integration_runtime_v0_1_20260826 - worker_03`
