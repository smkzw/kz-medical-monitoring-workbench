...
- Role id: `complex_manager_pi_qwen38`
...
- Runner-managed report path: `runs/execution/monitoring_p10_rule_release_chain_20260730/manager.md`. Never invoke write/edit tools
...
Output schema:
1. `# Execution Output: monitoring_p10_rule_release_chain_20260730 - complex_manager_pi_qwen38`
