...
- Runner-managed report path: `runs/execution/mm_r7_slice_06_harness_runtime_implementation_20260828/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 补齐 fake catalog/transport 故障注入、并发/租约/状态映射/泄漏/产品回归，并更新 README、receipt、阶段记录。
...
Output schema:
1. `# Execution Output: mm_r7_slice_06_harness_runtime_implementation_20260828 - worker_03`
