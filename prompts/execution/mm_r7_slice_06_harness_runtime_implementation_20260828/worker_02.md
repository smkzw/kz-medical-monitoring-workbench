...
- Runner-managed report path: `runs/execution/mm_r7_slice_06_harness_runtime_implementation_20260828/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 把 AI_CANDIDATE、continuable_ai_unit、两次 attempt 上限、停止/继续/重建语义最小接入 R7 background/runtime product seam。
...
Output schema:
1. `# Execution Output: mm_r7_slice_06_harness_runtime_implementation_20260828 - worker_02`
