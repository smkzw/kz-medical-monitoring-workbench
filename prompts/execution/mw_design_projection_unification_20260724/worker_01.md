...
- Runner-managed report path: `runs/execution/mw_design_projection_unification_20260724/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 设计NormalizedDesignProjection合同、StudyDefinition归一化入口、legacy自由文本回退边界和I期unresolved blocker
...
Output schema:
1. `# Execution Output: mw_design_projection_unification_20260724 - worker_01`
