...
- Runner-managed report path: `runs/execution/mw_design_projection_unification_20260724/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 设计并实现转组、交叉、OLE、样本量再估计、适应性设计typed对象及迁移/一致性校验
...
Output schema:
1. `# Execution Output: mw_design_projection_unification_20260724 - worker_02`
