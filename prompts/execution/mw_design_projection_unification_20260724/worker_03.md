...
- Runner-managed report path: `runs/execution/mw_design_projection_unification_20260724/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 将摘要、正文适用性、SoA、流程图、DOCX消费统一投影并建立多设计实际成品测试矩阵
...
Output schema:
1. `# Execution Output: mw_design_projection_unification_20260724 - worker_03`
