...
- Task id: `monitoring_p10_v10_visit_semantic_corrective_20260801`
...
- Runner-managed report path: `runs/execution/monitoring_p10_v10_visit_semantic_corrective_20260801/manager.md`. Never invoke write/edit tools
...
Initial read set:
- `AGENTS.md`
- `context/monitoring_p10_v10_visit_semantic_corrective_20260801_execution_context.md`
- `plans/codex_execution_monitoring_p10_v10_visit_semantic_corrective_20260801.md`
- `runs/execution/monitoring_p10_v10_visit_semantic_corrective_20260801/worker_01.md`
- `runs/execution/monitoring_p10_v10_visit_semantic_corrective_20260801/worker_02.md`
- `runs/execution/monitoring_p10_v10_visit_semantic_corrective_20260801/worker_03.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
Implement the offline v10 visit semantic corrective and deterministic regression gates
...
Output schema:
1. `# Execution Output: monitoring_p10_v10_visit_semantic_corrective_20260801 - finite_code_manager_cursor`
