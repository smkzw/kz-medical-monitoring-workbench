...
- Runner-managed report path: `runs/execution/mw_conversational_fact_intake_20260718/worker_02.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 桌面端无IB最小输入与对话式确认交互，移除重复必填
...
Output schema:
1. `# Execution Output: mw_conversational_fact_intake_20260718 - worker_02`
