...
- Runner-managed report path: `runs/execution/mw_conversational_fact_intake_20260718/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 多项目单元/API/浏览器测试与待医学批准语义审计
...
Output schema:
1. `# Execution Output: mw_conversational_fact_intake_20260718 - worker_03`
