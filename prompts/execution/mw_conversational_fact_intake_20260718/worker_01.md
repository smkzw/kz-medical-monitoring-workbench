...
- Runner-managed report path: `runs/execution/mw_conversational_fact_intake_20260718/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 后端合同、独立AI提示词、持久化会话和幂等API
...
Output schema:
1. `# Execution Output: mw_conversational_fact_intake_20260718 - worker_01`
