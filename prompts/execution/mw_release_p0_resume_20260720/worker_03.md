...
- Runner-managed report path: `runs/execution/mw_release_p0_resume_20260720/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Unify user-selection-is-confirmation semantics across backend contracts, API state, audit records, and frontend without a second medical approval.
...
Output schema:
1. `# Execution Output: mw_release_p0_resume_20260720 - worker_03`
