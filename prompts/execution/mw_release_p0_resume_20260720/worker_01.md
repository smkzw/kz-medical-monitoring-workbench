...
- Runner-managed report path: `runs/execution/mw_release_p0_resume_20260720/worker_01.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: Implement resumable asynchronous synopsis import with truthful progress, cancellation/retry, and DeepSeek v4-pro source-fidelity repair.
...
Output schema:
1. `# Execution Output: mw_release_p0_resume_20260720 - worker_01`
