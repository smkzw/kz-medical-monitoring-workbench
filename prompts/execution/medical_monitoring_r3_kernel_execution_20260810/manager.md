...
- Task id: `medical_monitoring_r3_kernel_execution_20260810`
...
Hard boundaries:
- Work only inside the runner working directory, which is the declared workspace root.
...
- Runner-managed report path: `runs/execution/medical_monitoring_r3_kernel_execution_20260810/manager.md`. Never invoke write/edit tools
...
Initial read set:
- `AGENTS.md`
- `context/medical_monitoring_r3_kernel_execution_20260810_execution_context.md`
- `plans/codex_execution_medical_monitoring_r3_kernel_execution_20260810.md`
- `runs/execution/medical_monitoring_r3_kernel_execution_20260810/worker_01.md`
- `runs/execution/medical_monitoring_r3_kernel_execution_20260810/worker_02.md`
- `runs/execution/medical_monitoring_r3_kernel_execution_20260810/worker_03.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
在独立 poc/medical_monitoring_ai_native_r3 命名空间实现 R3 Study Intelligence 与异构 listing 合成数据基座，并以确定性测试证明来源权威、冲突、结构画像、mapping、identity、规范化、diff 与自然语言规则生命周期；不得修改 R1/R2、产品、医学写作、真实项目或启动 8911。
...
Output schema:
1. `# Execution Output: medical_monitoring_r3_kernel_execution_20260810 - finite_code_manager_cursor`
