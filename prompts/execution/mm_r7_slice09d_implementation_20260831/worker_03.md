...
- Runner-managed report path: `runs/execution/mm_r7_slice09d_implementation_20260831/worker_03.md`. Never invoke write/edit tools
...
Task:
Execute only this assigned work item: 实现 fault/recovery matrix 与中文 DTO 投影验证：中断/cancel/lease/generation/迟到回调/backup/restore/migration/audit/log/resource 边界；复用现有 09A-09C seam，最小改动并完成 R1/R7 相邻回归。
...
Output schema:
1. `# Execution Output: mm_r7_slice09d_implementation_20260831 - worker_03`
