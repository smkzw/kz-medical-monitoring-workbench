...
- Runner-managed output path: `runs/codex_mw_protocol_p0_phase0c_word_receipt_persistence_20260802.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_protocol_p0_phase0c_word_receipt_persistence_20260802_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_protocol_p0_phase0c_word_receipt_persistence_20260802`
2. `## Boundary Check`
3. `## Direct Work`
