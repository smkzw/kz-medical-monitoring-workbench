...
- Runner-managed output path: `runs/codex_mm_r5_s5_typed_authority_resume_20260825.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mm_r5_s5_typed_authority_resume_20260825_context.md`
...
Output schema:
1. `# Codex Direct Task: mm_r5_s5_typed_authority_resume_20260825`
2. `## Boundary Check`
3. `## Direct Work`
