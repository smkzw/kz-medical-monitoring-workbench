...
- Runner-managed output path: `runs/codex_medical_monitoring_ai_diff_lineage_guard_20260805.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_ai_diff_lineage_guard_20260805_context.md`
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_ai_diff_lineage_guard_20260805`
2. `## Boundary Check`
3. `## Direct Work`
