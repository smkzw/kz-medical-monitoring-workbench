...
- Runner-managed output path: `runs/codex_mw_docx_indent_synopsis_qc_20260719.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_docx_indent_synopsis_qc_20260719_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_docx_indent_synopsis_qc_20260719`
2. `## Boundary Check`
3. `## Direct Work`
