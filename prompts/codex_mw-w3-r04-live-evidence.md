...
- Runner-managed output path: `runs/codex_mw-w3-r04-live-evidence.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-w3-r04-live-evidence_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-w3-r04-live-evidence`
2. `## Boundary Check`
3. `## Direct Work`
