...
- Runner-managed output path: `runs/codex-subagent_mw_protocol_p0_word_native_final_gate_fixture_20260802.md`. Do not write that report path with tools; return the complete handoff and let the runner persist it.
...
Output schema:
1. `# Codex SubAgent Task: mw_protocol_p0_word_native_final_gate_fixture_20260802`
2. `## Boundary Check`
3. `## Work Performed`
