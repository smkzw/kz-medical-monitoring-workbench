...
- Runner-managed output path: `runs/codex_mw_source_reference_reindex_20260722.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_source_reference_reindex_20260722_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_source_reference_reindex_20260722`
2. `## Boundary Check`
3. `## Direct Work`
