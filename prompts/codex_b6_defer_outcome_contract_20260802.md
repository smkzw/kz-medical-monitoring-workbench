...
- Runner-managed output path: `runs/codex_b6_defer_outcome_contract_20260802.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/b6_defer_outcome_contract_20260802_context.md`
...
Output schema:
1. `# Codex Direct Task: b6_defer_outcome_contract_20260802`
2. `## Boundary Check`
3. `## Direct Work`
