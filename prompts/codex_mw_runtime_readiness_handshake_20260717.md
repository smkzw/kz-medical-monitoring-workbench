...
- Write exactly one output file: `runs/codex_mw_runtime_readiness_handshake_20260717.md`.

Read these files only:
- `context/mw_runtime_readiness_handshake_20260717_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_runtime_readiness_handshake_20260717`
2. `## Boundary Check`
3. `## Direct Work`
