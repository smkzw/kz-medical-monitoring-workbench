...
- Runner-managed output path: `runs/codex_mw_protocol_p0_max_clean_rounds_20260805.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: mw_protocol_p0_max_clean_rounds_20260805`
2. `## Boundary Check`
3. `## Direct Work`
