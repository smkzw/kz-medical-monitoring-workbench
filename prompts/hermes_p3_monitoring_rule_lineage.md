...
- Runner-managed output path: `runs/hermes_p3_monitoring_rule_lineage.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/p3_monitoring_rule_lineage_context.md`
...
Output schema:
1. `# Hermes Task Plan: p3_monitoring_rule_lineage`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
