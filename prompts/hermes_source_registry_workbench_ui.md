...
- Write exactly one output file: `runs/hermes_source_registry_workbench_ui.md`.

Read these files only:
- `context/source_registry_workbench_ui_context.md`
...
Output schema:
1. `# Hermes Task Plan: source_registry_workbench_ui`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
