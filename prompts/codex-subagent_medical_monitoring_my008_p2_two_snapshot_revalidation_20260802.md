...
- Runner-managed output path: `runs/codex-subagent_medical_monitoring_my008_p2_two_snapshot_revalidation_20260802.md`. Do not write that report path with tools; return the complete handoff and let the runner persist it.

Read these files only:
- `context/medical_monitoring_my008_p2_two_snapshot_revalidation_20260802_context.md`
...
Output schema:
1. `# Codex SubAgent Task: medical_monitoring_my008_p2_two_snapshot_revalidation_20260802`
2. `## Boundary Check`
3. `## Work Performed`
