...
- Write exactly one output file: `runs/hermes_medical_writing_prelaunch_release_20260717_v2.md`.

Read these files only:
- `context/medical_writing_prelaunch_release_20260717_v2_context.md`
...
Output schema:
1. `# Hermes Task Plan: medical_writing_prelaunch_release_20260717_v2`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
