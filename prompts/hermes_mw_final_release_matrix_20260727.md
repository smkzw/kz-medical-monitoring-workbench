...
- Runner-managed output path: `runs/hermes_mw_final_release_matrix_20260727.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_final_release_matrix_20260727_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_final_release_matrix_20260727`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
