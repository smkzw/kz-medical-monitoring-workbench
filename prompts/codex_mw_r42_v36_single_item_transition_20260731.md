...
- Runner-managed output path: `runs/codex_mw_r42_v36_single_item_transition_20260731.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: mw_r42_v36_single_item_transition_20260731`
2. `## Boundary Check`
3. `## Direct Work`
