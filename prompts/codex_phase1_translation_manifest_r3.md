...
- Write exactly one output file: `runs/codex_phase1_translation_manifest_r3.md`.

Read these files only:
- `context/phase1_translation_manifest_r3_context.md`
...
Output schema:
1. `# Codex Direct Task: phase1_translation_manifest_r3`
2. `## Boundary Check`
3. `## Direct Work`
