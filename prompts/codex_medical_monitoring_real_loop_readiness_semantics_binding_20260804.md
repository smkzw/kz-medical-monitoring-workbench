...
- Runner-managed output path: `runs/codex_medical_monitoring_real_loop_readiness_semantics_binding_20260804.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_real_loop_readiness_semantics_binding_20260804_context.md`
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_real_loop_readiness_semantics_binding_20260804`
2. `## Boundary Check`
3. `## Direct Work`
