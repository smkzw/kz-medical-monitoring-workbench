...
- Runner-managed output path: `runs/codex_mw_r5_tester_a_batch_fix_20260728.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_r5_tester_a_batch_fix_20260728_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_r5_tester_a_batch_fix_20260728`
2. `## Boundary Check`
3. `## Direct Work`
