...
- Runner-managed output path: `runs/codex_mw-literature-word-link-release.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-literature-word-link-release_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-literature-word-link-release`
2. `## Boundary Check`
3. `## Direct Work`
