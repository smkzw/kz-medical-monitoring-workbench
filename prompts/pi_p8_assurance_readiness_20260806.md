...
- Runner-managed output path: `runs/pi_p8_assurance_readiness_20260806.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/p8_assurance_readiness_20260806_context.md`
...
Output schema:
1. `# Hermes Task Plan: p8_assurance_readiness_20260806`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
