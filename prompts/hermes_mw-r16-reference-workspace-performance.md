...
- Runner-managed output path: `runs/hermes_mw-r16-reference-workspace-performance.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-r16-reference-workspace-performance_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw-r16-reference-workspace-performance`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
