...
- Runner-managed output path: `runs/codex_mw-triage-missing-repair.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-triage-missing-repair_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-triage-missing-repair`
2. `## Boundary Check`
3. `## Direct Work`
