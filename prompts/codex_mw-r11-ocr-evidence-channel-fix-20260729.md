...
- Runner-managed output path: `runs/codex_mw-r11-ocr-evidence-channel-fix-20260729.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-r11-ocr-evidence-channel-fix-20260729_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-r11-ocr-evidence-channel-fix-20260729`
2. `## Boundary Check`
3. `## Direct Work`
