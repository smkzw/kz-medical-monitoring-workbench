...
- Runner-managed output path: `runs/hermes_mw_ai_roles_progress_v2.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_ai_roles_progress_v2_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_ai_roles_progress_v2`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
