...
- Runner-managed output path: `runs/codex_revision_fixture_migration.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/revision_fixture_migration_context.md`
...
Output schema:
1. `# Codex Direct Task: revision_fixture_migration`
2. `## Boundary Check`
3. `## Direct Work`
