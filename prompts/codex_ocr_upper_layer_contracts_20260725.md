...
- Runner-managed output path: `runs/codex_ocr_upper_layer_contracts_20260725.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/ocr_upper_layer_contracts_20260725_context.md`
...
Output schema:
1. `# Codex Direct Task: ocr_upper_layer_contracts_20260725`
2. `## Boundary Check`
3. `## Direct Work`
