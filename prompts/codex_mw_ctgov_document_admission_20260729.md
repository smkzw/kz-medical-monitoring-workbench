...
- Runner-managed output path: `runs/codex_mw_ctgov_document_admission_20260729.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_ctgov_document_admission_20260729_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_ctgov_document_admission_20260729`
2. `## Boundary Check`
3. `## Direct Work`
