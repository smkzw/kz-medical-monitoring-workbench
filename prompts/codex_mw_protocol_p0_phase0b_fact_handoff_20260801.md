...
- Runner-managed output path: `runs/codex_mw_protocol_p0_phase0b_fact_handoff_20260801.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_protocol_p0_phase0b_fact_handoff_20260801_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_protocol_p0_phase0b_fact_handoff_20260801`
2. `## Boundary Check`
3. `## Direct Work`
