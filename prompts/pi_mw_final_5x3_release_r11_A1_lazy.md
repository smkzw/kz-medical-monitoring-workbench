...
- Runner-managed output path: `runs/pi_mw_final_5x3_release_r11_A1_lazy.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_final_5x3_release_r11_A1_lazy_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_final_5x3_release_r11_A1_lazy`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
