...
- Runner-managed output path: `runs/codex_mw_scientific_e3_loop_20260724.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_scientific_e3_loop_20260724_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_scientific_e3_loop_20260724`
2. `## Boundary Check`
3. `## Direct Work`
