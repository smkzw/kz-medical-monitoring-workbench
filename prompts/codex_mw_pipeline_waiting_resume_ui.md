...
- Runner-managed output path: `runs/codex_mw_pipeline_waiting_resume_ui.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_pipeline_waiting_resume_ui_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_pipeline_waiting_resume_ui`
2. `## Boundary Check`
3. `## Direct Work`
