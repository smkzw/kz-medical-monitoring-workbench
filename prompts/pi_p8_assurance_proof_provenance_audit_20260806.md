This prompt was reserved by the workflow guard but was not dispatched. Direct Codex completed the bounded read-only provenance audit; no Hermes/provider action is authorized for this record.
...
- Runner-managed output path: `runs/pi_p8_assurance_proof_provenance_audit_20260806.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: p8_assurance_proof_provenance_audit_20260806`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
