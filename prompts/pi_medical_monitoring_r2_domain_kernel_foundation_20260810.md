...
- Runner-managed output path: `runs/pi_medical_monitoring_r2_domain_kernel_foundation_20260810.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: medical_monitoring_r2_domain_kernel_foundation_20260810`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
