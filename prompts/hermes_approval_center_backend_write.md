...
- Write exactly one output file: `runs/hermes_approval_center_backend_write.md`.

Read these files only:
- `context/approval_center_backend_write_context.md`
...
Output schema:
1. `# Hermes Task Plan: approval_center_backend_write`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
