...
- Runner-managed output path: `runs/codex_medical_monitoring_real_loop_gate_audit_20260804.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_real_loop_gate_audit_20260804`
2. `## Boundary Check`
3. `## Direct Work`
