...
- Runner-managed output path: `runs/pi_mw_final_5x3_A1_release_r20.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_final_5x3_A1_release_r20_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_final_5x3_A1_release_r20`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
