...
- Write exactly one output file: `runs/codex_mw_gap_rebaseline_20260717.md`.

Read these files only:
- `context/mw_gap_rebaseline_20260717_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_gap_rebaseline_20260717`
2. `## Boundary Check`
3. `## Direct Work`
