...
- Write exactly one output file: `runs/hermes_medical_writing_content_quality_20260714.md`.

Read these files only:
- `context/medical_writing_content_quality_20260714_context.md`
...
Output schema:
1. `# Hermes Task Plan: medical_writing_content_quality_20260714`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
