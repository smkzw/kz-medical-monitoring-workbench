...
- Runner-managed output path: `runs/codex_medical_monitoring_primary_run_write_authorization_20260804.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_primary_run_write_authorization_20260804_context.md`
...
Task:
Review the task context and complete the requested bounded `/runs` write
authorization slice directly. Keep protocol/rule writes, authentication
providers and live gates closed. Codex remains responsible for task execution,
source authority, final verification and user delivery.

Output schema:
1. `# Codex Direct Task: medical_monitoring_primary_run_write_authorization_20260804`
2. `## Boundary Check`
3. `## Direct Work`
