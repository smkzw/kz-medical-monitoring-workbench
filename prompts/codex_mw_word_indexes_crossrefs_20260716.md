...
- Write exactly one output file: `runs/codex_mw_word_indexes_crossrefs_20260716.md`.

Read these files only:
- `context/mw_word_indexes_crossrefs_20260716_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_word_indexes_crossrefs_20260716`
2. `## Boundary Check`
3. `## Direct Work`
