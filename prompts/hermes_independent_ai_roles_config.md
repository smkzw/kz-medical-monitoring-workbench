...
- Runner-managed output path: `runs/hermes_independent_ai_roles_config.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/independent_ai_roles_config_context.md`
...
Output schema:
1. `# Hermes Task Plan: independent_ai_roles_config`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
