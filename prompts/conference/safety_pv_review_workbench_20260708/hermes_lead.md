...
- Write exactly one output file: `runs/conference/safety_pv_review_workbench_20260708/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: safety_pv_review_workbench_20260708 - hermes_lead`
2. `## Inputs Reviewed`
