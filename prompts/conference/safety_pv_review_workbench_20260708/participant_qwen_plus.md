...
- Write exactly one output file: `runs/conference/safety_pv_review_workbench_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: safety_pv_review_workbench_20260708 - participant_qwen_plus`
2. `## Boundary Check`
