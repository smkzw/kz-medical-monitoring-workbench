...
- Runner-managed report path: `runs/conference/mm_r7_slice08b_contract_acceptance_20260829/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice08b_contract_acceptance_20260829_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice08b_contract_acceptance_20260829.md`
...
Objective:
独立挑战并验收 reviews/medical_monitoring_r7_slice08b_authority_artifact_bridge_contract_v0_1_20260829.md：重点核实是否正确复用R1 Store、R5 typed packet、R6 validator，publication v4字段是否最小，子项闭集是否符合三模式与冻结Slice-08合同；不得修改源码或启动服务
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice08b_contract_acceptance_20260829 - general_single_object`
2. `## Boundary Check`
