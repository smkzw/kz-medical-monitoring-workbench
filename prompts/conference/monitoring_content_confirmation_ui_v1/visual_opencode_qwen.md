...
- Write exactly one output file: `runs/conference/monitoring_content_confirmation_ui_v1/visual_opencode_qwen.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Task:
Audit density, hierarchy, overflow, accessibility, and misleading clinical semantics. Propose exact acceptance checks for the inline confirmation state. Do not edit code or look at other outputs.

Output schema:
1. `# Conference Participant Output: monitoring_content_confirmation_ui_v1 - visual_opencode_qwen`
2. `## Boundary Check`
