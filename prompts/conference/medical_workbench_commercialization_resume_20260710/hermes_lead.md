...
- Write exactly one output file: `runs/conference/medical_workbench_commercialization_resume_20260710/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: medical_workbench_commercialization_resume_20260710 - hermes_lead`
2. `## Inputs Reviewed`
