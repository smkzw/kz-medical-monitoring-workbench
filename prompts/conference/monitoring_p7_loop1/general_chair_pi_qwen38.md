...
- Runner-managed report path: `runs/conference/monitoring_p7_loop1/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/monitoring_p7_loop1_conference_context.md`
- `plans/codex_main_venue_monitoring_p7_loop1.md`
- `runs/conference/monitoring_p7_loop1/general_aishuo_cms.md`
- `runs/conference/monitoring_p7_loop1/general_codebuddy_deepseek_pro.md`
...
Output schema:
1. `# Sub-Venue Review: monitoring_p7_loop1 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
