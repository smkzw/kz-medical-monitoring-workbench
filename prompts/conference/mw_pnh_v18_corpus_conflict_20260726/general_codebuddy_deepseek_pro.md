...
- Do not write the runner-managed report path `runs/conference/mw_pnh_v18_corpus_conflict_20260726/general_codebuddy_deepseek_pro.md`; return the complete report for the runner.
...
Output schema:
1. `# Conference Participant Output: mw_pnh_v18_corpus_conflict_20260726 - general_codebuddy_deepseek_pro`
2. `## Boundary Check`
