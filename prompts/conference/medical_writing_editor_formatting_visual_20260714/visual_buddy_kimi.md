...
- Write exactly one output file: `runs/conference/medical_writing_editor_formatting_visual_20260714/visual_buddy_kimi.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: medical_writing_editor_formatting_visual_20260714 - visual_buddy_kimi`
2. `## Boundary Check`
