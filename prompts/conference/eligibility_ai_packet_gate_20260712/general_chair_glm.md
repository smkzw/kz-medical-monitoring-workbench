...
- Write exactly one output file: `runs/conference/eligibility_ai_packet_gate_20260712/general_chair_glm.md`. The bounded runner persists your final response there; do not create sibling output files.
...
- `runs/conference/eligibility_ai_packet_gate_20260712/general_aishuo_minimax.md`
- `runs/conference/eligibility_ai_packet_gate_20260712/general_buddy_deepseek.md`
- `runs/conference/eligibility_ai_packet_gate_20260712/general_opencode_mimo.md`

Objective:
复核入排审核AI受控证据packet、调用前版本/QC门禁、packet幂等和公共API身份边界
...
Output schema:
1. `# Hermes Sub-Venue Review: eligibility_ai_packet_gate_20260712 - general_chair_glm`
2. `## Inputs Reviewed`
