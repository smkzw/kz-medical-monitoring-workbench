...
- Role description: participant 2 for complex, logic-heavy, evidence-sensitive, artifact-heavy, and high-risk contradiction review; Grok Build only, then CMS Router
...
- Runner-managed report path: `runs/conference/mm_r6_contract_acceptance_conference_v0_1_20260827/general_grok46.md`. Never invoke write/edit tools
  to create or update this report file; return the complete report in your
  final assistant response and let the bounded runner persist it. Do not create
  sibling output files.

Initial read set:
- `context/mm_r6_contract_acceptance_conference_v0_1_20260827_conference_context.md`
- `plans/codex_main_venue_mm_r6_contract_acceptance_conference_v0_1_20260827.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
独立挑战并裁决 R6 外部报告审阅与三模式输出合同稳定字节：核对 prose、contract.json、challenge_matrix.json 的闭合性、实现可行性、枚举/身份/coverage/三件套/修订diff/三模式/错误语义一致性；仅合同审阅，不修改文件、不启动服务或真实项目。
...
Output schema:
1. `# Conference Participant Output: mm_r6_contract_acceptance_conference_v0_1_20260827 - general_grok46`
2. `## Boundary Check`
