...
- Runner-managed report path: `runs/conference/mm_r6_contract_acceptance_conference_v0_1_20260827/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: mm_r6_contract_acceptance_conference_v0_1_20260827 - general_pi_antigravity`
2. `## Boundary Check`
