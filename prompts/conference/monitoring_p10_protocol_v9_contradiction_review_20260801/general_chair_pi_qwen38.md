...
- Runner-managed report path: `runs/conference/monitoring_p10_protocol_v9_contradiction_review_20260801/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
- `runs/conference/monitoring_p10_protocol_v9_contradiction_review_20260801/general_pi_deepseek_flash.md`
...
Output schema:
1. `# Sub-Venue Review: monitoring_p10_protocol_v9_contradiction_review_20260801 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
