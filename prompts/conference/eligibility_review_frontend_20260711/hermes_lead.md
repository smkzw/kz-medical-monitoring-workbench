...
- Write exactly one output file: `runs/conference/eligibility_review_frontend_20260711/hermes_lead.md`.
...
- `runs/conference/eligibility_review_frontend_20260711/participant_qwen_plus.md`
- `runs/conference/eligibility_review_frontend_20260711/participant_mimo.md`
- `runs/conference/eligibility_review_frontend_20260711/participant_ds_flash.md`
...
Output schema:
1. `# Hermes Sub-Venue Review: eligibility_review_frontend_20260711 - hermes_lead`
2. `## Inputs Reviewed`
