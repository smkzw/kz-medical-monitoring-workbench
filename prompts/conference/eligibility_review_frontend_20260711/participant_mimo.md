...
- Write exactly one output file: `runs/conference/eligibility_review_frontend_20260711/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: eligibility_review_frontend_20260711 - participant_mimo`
2. `## Boundary Check`
