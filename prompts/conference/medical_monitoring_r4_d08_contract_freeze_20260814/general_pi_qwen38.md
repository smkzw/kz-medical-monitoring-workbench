...
- Runner-managed report path: `runs/conference/medical_monitoring_r4_d08_contract_freeze_20260814/general_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/medical_monitoring_r4_d08_contract_freeze_20260814_conference_context.md`
- `plans/codex_main_venue_medical_monitoring_r4_d08_contract_freeze_20260814.md`
...
Objective:
对D08 v0.6同一不可变catalog/oracle/registry/generator/test快照执行只读独立冻结验收，决定ACCEPT_D08_CONTRACT或REVISE_D08_CONTRACT
...
Output schema:
1. `# Conference Participant Output: medical_monitoring_r4_d08_contract_freeze_20260814 - general_pi_qwen38`
2. `## Boundary Check`
