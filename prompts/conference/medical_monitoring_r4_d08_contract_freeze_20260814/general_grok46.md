...
- Runner-managed report path: `runs/conference/medical_monitoring_r4_d08_contract_freeze_20260814/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: medical_monitoring_r4_d08_contract_freeze_20260814 - general_grok46`
2. `## Boundary Check`
