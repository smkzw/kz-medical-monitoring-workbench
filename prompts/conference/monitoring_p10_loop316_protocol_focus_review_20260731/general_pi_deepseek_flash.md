...
- Runner-managed report path: `runs/conference/monitoring_p10_loop316_protocol_focus_review_20260731/general_pi_deepseek_flash.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: monitoring_p10_loop316_protocol_focus_review_20260731 - general_pi_deepseek_flash`
2. `## Boundary Check`
