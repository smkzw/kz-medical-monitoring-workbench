...
- Runner-managed report path: `runs/conference/monitoring-p8a-backend-review/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/monitoring-p8a-backend-review_conference_context.md`
- `plans/codex_main_venue_monitoring-p8a-backend-review.md`
- `runs/conference/monitoring-p8a-backend-review/general_aishuo_cms.md`
- `runs/conference/monitoring-p8a-backend-review/general_codebuddy_deepseek_pro.md`
...
Output schema:
1. `# Sub-Venue Review: monitoring-p8a-backend-review - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
