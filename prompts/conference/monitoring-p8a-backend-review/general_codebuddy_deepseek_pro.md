...
- Do not write the runner-managed report path `runs/conference/monitoring-p8a-backend-review/general_codebuddy_deepseek_pro.md`; return the complete report for the runner.
...
Output schema:
1. `# Conference Participant Output: monitoring-p8a-backend-review - general_codebuddy_deepseek_pro`
2. `## Boundary Check`
