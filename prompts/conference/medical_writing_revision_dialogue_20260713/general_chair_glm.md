...
- Write exactly one output file: `runs/conference/medical_writing_revision_dialogue_20260713/general_chair_glm.md`. The bounded runner persists your final response there; do not create sibling output files.
...
- `runs/conference/medical_writing_revision_dialogue_20260713/general_aishuo_minimax.md`
- `runs/conference/medical_writing_revision_dialogue_20260713/general_buddy_deepseek.md`
- `runs/conference/medical_writing_revision_dialogue_20260713/general_opencode_mimo.md`
...
Output schema:
1. `# Hermes Sub-Venue Review: medical_writing_revision_dialogue_20260713 - general_chair_glm`
2. `## Inputs Reviewed`
