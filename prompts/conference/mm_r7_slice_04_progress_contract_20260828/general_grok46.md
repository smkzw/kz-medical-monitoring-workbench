...
- Runner-managed report path: `runs/conference/mm_r7_slice_04_progress_contract_20260828/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice_04_progress_contract_20260828 - general_grok46`
2. `## Boundary Check`
