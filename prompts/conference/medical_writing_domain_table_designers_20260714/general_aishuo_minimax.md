...
- Write exactly one output file: `runs/conference/medical_writing_domain_table_designers_20260714/general_aishuo_minimax.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: medical_writing_domain_table_designers_20260714 - general_aishuo_minimax`
2. `## Boundary Check`
