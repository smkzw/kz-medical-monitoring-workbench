...
- Runner-managed report path: `runs/conference/mm_r7_slice09e_contract_review_20260831/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice09e_contract_review_20260831_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice09e_contract_review_20260831.md`
...
Objective:
独立审阅R7阶段复盘与Slice-09E本地分发数据处置合同，判断09E是否必要、范围是否最小、是否可进入实施，并输出P0-P4缺陷与明确结论。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice09e_contract_review_20260831 - general_single_object`
2. `## Boundary Check`
