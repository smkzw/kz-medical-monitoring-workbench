...
- Runner-managed report path: `runs/conference/mm_r6_runtime_slice_06_acceptance_20260828/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r6_runtime_slice_06_acceptance_20260828_conference_context.md`
- `plans/codex_main_venue_mm_r6_runtime_slice_06_acceptance_20260828.md`
...
Objective:
Independently challenge and decide limited synthetic/offline acceptance readiness of R6 slice-06 post_lock_pre_cfdi fixed-total outputs against the frozen contract, focusing on fail-open identity, totals, nested references, immutable draft boundaries, and test adequacy.
...
Output schema:
1. `# Conference Participant Output: mm_r6_runtime_slice_06_acceptance_20260828 - general_pi_antigravity`
2. `## Boundary Check`
