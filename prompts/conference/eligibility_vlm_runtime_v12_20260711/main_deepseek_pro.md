...
- Write exactly one output file: `runs/conference/eligibility_vlm_runtime_v12_20260711/main_deepseek_pro.md`.
...
- `runs/conference/eligibility_vlm_runtime_v12_20260711/hermes_lead.md`
- `reviews/codex_conference_eligibility_vlm_runtime_v12_20260711_review.md`
- `metrics/eligibility_vlm_runtime_v12_20260711_conference_metrics.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: eligibility_vlm_runtime_v12_20260711`
2. `## Inputs Reviewed`
