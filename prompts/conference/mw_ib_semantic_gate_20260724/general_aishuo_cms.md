...
- Runner-managed report path: `runs/conference/mw_ib_semantic_gate_20260724/general_aishuo_cms.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_ib_semantic_gate_20260724 - general_aishuo_cms`
2. `## Boundary Check`
