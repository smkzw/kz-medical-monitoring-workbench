...
- Runner-managed report path: `runs/conference/mm_r6_runtime_slice_04_acceptance_20260828/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mm_r6_runtime_slice_04_acceptance_20260828 - general_grok46`
2. `## Boundary Check`
