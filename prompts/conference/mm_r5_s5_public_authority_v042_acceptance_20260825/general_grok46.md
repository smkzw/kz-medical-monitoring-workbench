...
- Runner-managed report path: `runs/conference/mm_r5_s5_public_authority_v042_acceptance_20260825/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mm_r5_s5_public_authority_v042_acceptance_20260825 - general_grok46`
2. `## Boundary Check`
