...
- Runner-managed report path: `runs/conference/mm_r7_slice08d_contract_20260830/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice08d_contract_20260830_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice08d_contract_20260830.md`
...
Objective:
独立挑战并冻结R7 Slice-08D三模式synthetic综合回归合同，核对三模式语义、确定性、故障恢复、相邻回归、用户中文边界和P0-P4完成门；不修改产品、不启动服务/真实项目/模型、不触碰医学写作
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice08d_contract_20260830 - general_single_object`
2. `## Boundary Check`
