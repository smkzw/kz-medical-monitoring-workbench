...
- Runner-managed report path: `runs/conference/mm_r7_slice07c4_visual_acceptance_conference_20260829/visual_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice07c4_visual_acceptance_conference_20260829_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice07c4_visual_acceptance_conference_20260829.md`
...
Objective:
独立审阅 R7 Slice-07C-4 当前中文医学监查产品闭环的 ego(lite) 视觉证据，核查 1280/1440/1920 的信息层级、项目与中心流向、受试者访视轴、风险定位、范围身份、中文文案、焦点与溢出，并对是否存在阻塞级用户体验缺陷提出证据化结论；不得修改产品、不得接触真实项目或模型运行。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice07c4_visual_acceptance_conference_20260829 - visual_single_object`
2. `## Boundary Check`
