...
- Write exactly one output file: `runs/conference/live_workbench_qc_20260707/main_deepseek_pro.md`.

Read these files only:
- `context/live_workbench_qc_20260707_conference_context.md`
- `plans/codex_main_venue_live_workbench_qc_20260707.md`
- `runs/conference/live_workbench_qc_20260707/participant_qwen_plus.md`
- `runs/conference/live_workbench_qc_20260707/participant_mimo.md`
- `runs/conference/live_workbench_qc_20260707/participant_ds_flash.md`
- `runs/conference/live_workbench_qc_20260707/hermes_lead.md`
- `reviews/codex_conference_live_workbench_qc_20260707_review.md`
- `metrics/live_workbench_qc_20260707_conference_metrics.md`

Objective:
四个指定 Hermes/OpenCode 模型实际访问康哲 AI 医学经理工作台本地前后端，执行独立前后端验收并写入报告
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: live_workbench_qc_20260707`
2. `## Inputs Reviewed`
