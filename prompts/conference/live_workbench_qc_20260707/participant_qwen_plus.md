...
- Model: `qwen3.7-plus`
- Output file: `runs/conference/live_workbench_qc_20260707/participant_qwen_plus.md`
...
Write exactly one output file: `runs/conference/live_workbench_qc_20260707/participant_qwen_plus.md`
...
Report schema:
# Live Workbench QA - qwen3.7-plus
## Route And Access
