...
- Write exactly one output file: `runs/conference/evidence_picos_productization_20260710/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: evidence_picos_productization_20260710 - hermes_lead`
2. `## Inputs Reviewed`
