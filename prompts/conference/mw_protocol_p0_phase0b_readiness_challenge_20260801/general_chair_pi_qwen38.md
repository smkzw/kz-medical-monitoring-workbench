...
- Runner-managed report path: `runs/conference/mw_protocol_p0_phase0b_readiness_challenge_20260801/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/mw_protocol_p0_phase0b_readiness_challenge_20260801_conference_context.md`
- `plans/codex_main_venue_mw_protocol_p0_phase0b_readiness_challenge_20260801.md`
- `runs/conference/mw_protocol_p0_phase0b_readiness_challenge_20260801/general_codex_luna.md`
- `runs/conference/mw_protocol_p0_phase0b_readiness_challenge_20260801/general_pi_deepseek_flash.md`
...
Objective:
Independently challenge the Protocol P0 Phase 0B typed drafting readiness slice for blank-draft compatibility, fail-closed clinical semantics, AI-first UX, idempotency, and medical-monitoring boundary preservation
...
Output schema:
1. `# Sub-Venue Review: mw_protocol_p0_phase0b_readiness_challenge_20260801 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
