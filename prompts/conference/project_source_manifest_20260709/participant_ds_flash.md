...
- Write exactly one output file: `runs/conference/project_source_manifest_20260709/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: project_source_manifest_20260709 - participant_ds_flash`
2. `## Boundary Check`
