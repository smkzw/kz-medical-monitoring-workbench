...
- Write exactly one output file: `runs/conference/project_source_manifest_20260709/main_deepseek_pro.md`.

Read these files only:
- `context/project_source_manifest_20260709_conference_context.md`
- `plans/codex_main_venue_project_source_manifest_20260709.md`
- `runs/conference/project_source_manifest_20260709/participant_qwen_plus.md`
- `runs/conference/project_source_manifest_20260709/participant_mimo.md`
- `runs/conference/project_source_manifest_20260709/participant_ds_flash.md`
- `runs/conference/project_source_manifest_20260709/hermes_lead.md`
- `reviews/codex_conference_project_source_manifest_20260709_review.md`
- `metrics/project_source_manifest_20260709_conference_metrics.md`

Objective:
Build ProjectSourceManifest as the unified real-project source and identity layer for the medical manager workbench, covering dashboard, eligibility, monitoring, TFL, writing, safety/PV, and source-boundary governance.
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: project_source_manifest_20260709`
2. `## Inputs Reviewed`
