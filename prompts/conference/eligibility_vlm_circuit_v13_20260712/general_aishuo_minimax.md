...
- Write exactly one output file: `runs/conference/eligibility_vlm_circuit_v13_20260712/general_aishuo_minimax.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: eligibility_vlm_circuit_v13_20260712 - general_aishuo_minimax`
2. `## Boundary Check`
