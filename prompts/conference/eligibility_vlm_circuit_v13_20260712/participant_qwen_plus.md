...
Role: participant_qwen_plus
Assigned route: opencode-go / qwen3.7-plus
Hard boundaries:
- Read only the listed files; no edits, tests, web, browser, images, or real clinical data.
- Write exactly one output file: `runs/conference/eligibility_vlm_circuit_v13_20260712/participant_qwen_plus.md`.
