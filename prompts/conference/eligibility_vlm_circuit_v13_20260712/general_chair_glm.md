...
- Write exactly one output file: `runs/conference/eligibility_vlm_circuit_v13_20260712/general_chair_glm.md`. The bounded runner persists your final response there; do not create sibling output files.
...
- `runs/conference/eligibility_vlm_circuit_v13_20260712/general_aishuo_minimax.md`
- `runs/conference/eligibility_vlm_circuit_v13_20260712/general_buddy_deepseek.md`
- `runs/conference/eligibility_vlm_circuit_v13_20260712/general_antigravity_gemini35.md`

Objective:
Review the bounded SQLite v13 durable multi-process VLM circuit, worker admission accounting, migration safety, and remaining production gates without authorizing clinical images or a production VLM profile
...
Output schema:
1. `# Hermes Sub-Venue Review: eligibility_vlm_circuit_v13_20260712 - general_chair_glm`
2. `## Inputs Reviewed`
