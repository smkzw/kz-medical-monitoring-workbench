...
- Runner-managed report path: `runs/conference/mm_r7_slice06_matrix14_bridge_fix_review_20260828/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice06_matrix14_bridge_fix_review_20260828_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice06_matrix14_bridge_fix_review_20260828.md`
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice06_matrix14_bridge_fix_review_20260828 - general_pi_antigravity`
2. `## Boundary Check`
