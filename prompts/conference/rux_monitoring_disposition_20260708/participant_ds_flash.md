...
- Write exactly one output file: `runs/conference/rux_monitoring_disposition_20260708/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: rux_monitoring_disposition_20260708 - participant_ds_flash`
2. `## Boundary Check`
