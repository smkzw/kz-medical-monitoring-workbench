...
- Write exactly one output file: `runs/conference/rux_monitoring_disposition_20260708/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: rux_monitoring_disposition_20260708 - hermes_lead`
2. `## Inputs Reviewed`
