...
- Write exactly one output file: `runs/conference/rux_monitoring_disposition_20260708/main_deepseek_pro.md`.
...
- `runs/conference/rux_monitoring_disposition_20260708/participant_qwen_plus.md`
- `runs/conference/rux_monitoring_disposition_20260708/participant_mimo.md`
- `runs/conference/rux_monitoring_disposition_20260708/participant_ds_flash.md`
- `runs/conference/rux_monitoring_disposition_20260708/hermes_lead.md`
- `reviews/codex_conference_rux_monitoring_disposition_20260708_review.md`
- `metrics/rux_monitoring_disposition_20260708_conference_metrics.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: rux_monitoring_disposition_20260708`
2. `## Inputs Reviewed`
