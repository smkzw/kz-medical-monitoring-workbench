...
- Write exactly one output file: `runs/conference/rux_monitoring_disposition_20260708/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: rux_monitoring_disposition_20260708 - participant_mimo`
2. `## Boundary Check`
