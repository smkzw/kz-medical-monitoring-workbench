...
- Runner-managed report path: `runs/conference/mm_r7_slice09a_implementation_acceptance_20260830/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice09a_implementation_acceptance_20260830_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice09a_implementation_acceptance_20260830.md`
...
Objective:
独立审查 R7 Slice-09A 当前 synthetic/offline 项目备份恢复实现、产品路由、后台执行、锁与回滚语义、测试和执行证据；逐项核对冻结 v0.3 合同，输出 P0-P4、精确文件行号、修复要求和 ACCEPT/VETO。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice09a_implementation_acceptance_20260830 - general_single_object`
2. `## Boundary Check`
