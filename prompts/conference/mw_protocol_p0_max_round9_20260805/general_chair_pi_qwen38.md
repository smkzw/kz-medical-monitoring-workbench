...
- Do not write the runner-managed report path `runs/conference/mw_protocol_p0_max_round9_20260805/general_chair_pi_qwen38.md`; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/mw_protocol_p0_max_round9_20260805_conference_context.md`
- `plans/codex_main_venue_mw_protocol_p0_max_round9_20260805.md`
- `runs/conference/mw_protocol_p0_max_round9_20260805/general_pi_deepseek_flash.md`
...
Objective:
独立工程师角色对固定 DeepSeek V4 Flash max/PaddleOCR/Hy-MT2 Protocol 工作流进行干净克隆、可视端到端反证审阅；与医学监察员用户角色严格分离。
...
Output schema:
1. `# Sub-Venue Review: mw_protocol_p0_max_round9_20260805 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
