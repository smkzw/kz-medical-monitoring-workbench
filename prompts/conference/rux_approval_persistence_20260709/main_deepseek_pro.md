...
- Write exactly one output file: `runs/conference/rux_approval_persistence_20260709/main_deepseek_pro.md`.
...
- `runs/conference/rux_approval_persistence_20260709/hermes_lead.md`
- `reviews/codex_conference_rux_approval_persistence_20260709_review.md`
- `metrics/rux_approval_persistence_20260709_conference_metrics.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: rux_approval_persistence_20260709`
2. `## Inputs Reviewed`
