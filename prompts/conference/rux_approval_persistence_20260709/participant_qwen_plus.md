...
- Write exactly one output file: `runs/conference/rux_approval_persistence_20260709/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: rux_approval_persistence_20260709 - participant_qwen_plus`
2. `## Boundary Check`
