...
- Write exactly one output file: `runs/conference/rux_approval_persistence_20260709/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: rux_approval_persistence_20260709 - participant_mimo`
2. `## Boundary Check`
