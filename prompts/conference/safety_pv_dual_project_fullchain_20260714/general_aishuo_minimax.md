...
- Write exactly one output file: `runs/conference/safety_pv_dual_project_fullchain_20260714/general_aishuo_minimax.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: safety_pv_dual_project_fullchain_20260714 - general_aishuo_minimax`
2. `## Boundary Check`
