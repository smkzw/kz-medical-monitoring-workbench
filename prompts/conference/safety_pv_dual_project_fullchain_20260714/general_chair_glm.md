...
- Write exactly one output file: `runs/conference/safety_pv_dual_project_fullchain_20260714/general_chair_glm.md`. The bounded runner persists your final response there; do not create sibling output files.
...
- `runs/conference/safety_pv_dual_project_fullchain_20260714/general_aishuo_minimax.md`
- `runs/conference/safety_pv_dual_project_fullchain_20260714/general_buddy_deepseek.md`
- `runs/conference/safety_pv_dual_project_fullchain_20260714/general_opencode_mimo.md`
...
Output schema:
1. `# Hermes Sub-Venue Review: safety_pv_dual_project_fullchain_20260714 - general_chair_glm`
2. `## Inputs Reviewed`
