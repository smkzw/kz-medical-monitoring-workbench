...
- Runner-managed report path: `runs/conference/mw-ai-generalization-batch-ux-r32/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
separable and traceable. Do not open or modify the running r32 A1 runtime.
...
Output schema:
1. `# Sub-Venue Review: mw-ai-generalization-batch-ux-r32 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
