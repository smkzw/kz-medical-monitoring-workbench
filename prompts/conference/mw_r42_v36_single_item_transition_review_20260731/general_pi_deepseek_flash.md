...
- Runner-managed report path: `runs/conference/mw_r42_v36_single_item_transition_review_20260731/general_pi_deepseek_flash.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: mw_r42_v36_single_item_transition_review_20260731 - general_pi_deepseek_flash`
2. `## Boundary Check`
