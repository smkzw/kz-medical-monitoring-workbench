...
- Runner-managed report path: `runs/conference/mm_r6_runtime_slice_03_acceptance_20260827/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r6_runtime_slice_03_acceptance_20260827_conference_context.md`
- `plans/codex_main_venue_mm_r6_runtime_slice_03_acceptance_20260827.md`
...
Output schema:
1. `# Conference Participant Output: mm_r6_runtime_slice_03_acceptance_20260827 - general_pi_antigravity`
2. `## Boundary Check`
