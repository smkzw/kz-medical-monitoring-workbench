...
- Runner-managed report path: `runs/conference/mw_current_full_audit_20260722/general_aishuo_cms.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_current_full_audit_20260722 - general_aishuo_cms`
2. `## Boundary Check`
