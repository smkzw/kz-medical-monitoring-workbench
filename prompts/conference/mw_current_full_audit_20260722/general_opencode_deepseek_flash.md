...
- Runner-managed report path: `runs/conference/mw_current_full_audit_20260722/general_opencode_deepseek_flash.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_current_full_audit_20260722 - general_opencode_deepseek_flash`
2. `## Boundary Check`
