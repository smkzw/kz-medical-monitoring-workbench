...
- Runner-managed report path: `runs/conference/medical_monitoring_r3_nl_rule_adapter_acceptance_20260810/general_grok45.md`. Never invoke write/edit tools
...
Output schema:
1. Verdict line
2. `# Conference Participant Output: medical_monitoring_r3_nl_rule_adapter_acceptance_20260810 - general_grok45`
3. `## Boundary Check`
