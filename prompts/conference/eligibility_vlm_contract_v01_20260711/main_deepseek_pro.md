...
- Write exactly one output file: `runs/conference/eligibility_vlm_contract_v01_20260711/main_deepseek_pro.md`.
...
- `runs/conference/eligibility_vlm_contract_v01_20260711/hermes_lead.md`
- `records/active_slices/eligibility_next_slice_20260711/VLM_CLOSED_VOCABULARY_CONTRACT_V0_1.md`
- `reviews/codex_conference_eligibility_vlm_contract_v01_20260711_review.md`
- `metrics/eligibility_vlm_contract_v01_20260711_conference_metrics.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: eligibility_vlm_contract_v01_20260711`
2. `## Inputs Reviewed`
