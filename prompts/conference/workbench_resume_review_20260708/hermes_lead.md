...
- Write exactly one output file: `runs/conference/workbench_resume_review_20260708/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: workbench_resume_review_20260708 - hermes_lead`
2. `## Inputs Reviewed`
