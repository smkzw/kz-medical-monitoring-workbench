...
- Write exactly one output file: `runs/conference/workbench_resume_review_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: workbench_resume_review_20260708 - participant_qwen_plus`
2. `## Boundary Check`
