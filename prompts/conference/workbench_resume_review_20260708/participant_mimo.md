...
- Write exactly one output file: `runs/conference/workbench_resume_review_20260708/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: workbench_resume_review_20260708 - participant_mimo`
2. `## Boundary Check`
