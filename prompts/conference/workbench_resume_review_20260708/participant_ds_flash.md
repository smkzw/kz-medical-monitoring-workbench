...
- Write exactly one output file: `runs/conference/workbench_resume_review_20260708/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: workbench_resume_review_20260708 - participant_ds_flash`
2. `## Boundary Check`
