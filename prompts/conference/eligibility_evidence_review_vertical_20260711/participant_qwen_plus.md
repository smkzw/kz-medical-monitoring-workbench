...
- Write exactly one output file: `runs/conference/eligibility_evidence_review_vertical_20260711/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: eligibility_evidence_review_vertical_20260711 - participant_qwen_plus`
2. `## Boundary Check`
