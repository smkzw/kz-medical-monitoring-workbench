...
- Do not write the runner-managed report path `runs/conference/mw_translation_identity_v2_review_20260727/general_codebuddy_deepseek_pro.md`; return the complete report for the runner.
...
Output schema:
1. `# Conference Participant Output: mw_translation_identity_v2_review_20260727 - general_codebuddy_deepseek_pro`
2. `## Boundary Check`
