...
- Runner-managed report path: `runs/conference/mw_translation_identity_v2_review_20260727/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
- `runs/conference/mw_translation_identity_v2_review_20260727/general_aishuo_cms.md`
- `runs/conference/mw_translation_identity_v2_review_20260727/general_codebuddy_deepseek_pro.md`
...
Output schema:
1. `# Sub-Venue Review: mw_translation_identity_v2_review_20260727 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
