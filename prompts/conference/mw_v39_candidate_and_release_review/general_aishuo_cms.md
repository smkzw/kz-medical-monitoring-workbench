...
- Runner-managed report path: `runs/conference/mw_v39_candidate_and_release_review/general_aishuo_cms.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_v39_candidate_and_release_review - general_aishuo_cms`
2. `## Boundary Check`
