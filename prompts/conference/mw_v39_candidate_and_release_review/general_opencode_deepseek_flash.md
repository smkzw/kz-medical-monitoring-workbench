...
- Runner-managed report path: `runs/conference/mw_v39_candidate_and_release_review/general_opencode_deepseek_flash.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_v39_candidate_and_release_review - general_opencode_deepseek_flash`
2. `## Boundary Check`
