...
- Write exactly one output file: `runs/conference/mw_editor_refs_conference_20260715/general_aishuo_minimax.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: mw_editor_refs_conference_20260715 - general_aishuo_minimax`
2. `## Boundary Check`
