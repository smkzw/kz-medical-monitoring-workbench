...
- Runner-managed report path: `runs/conference/mm_r7_slice09c_contract_acceptance_20260830/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice09c_contract_acceptance_20260830_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice09c_contract_acceptance_20260830.md`
...
Objective:
独立审阅 R7 Slice-09C 业务审计核验与技术日志轮转合同 v0.1，逐条核对既有 09A/09B 边界、D16、当前源代码与产品中文语义，按 P0-P4 给出可执行缺口；只有全部清零才可接受，禁止扩大到真实项目、模型、浏览器、医学写作、安全专项、UI 或性能 Slice-09D。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice09c_contract_acceptance_20260830 - general_single_object`
2. `## Boundary Check`
