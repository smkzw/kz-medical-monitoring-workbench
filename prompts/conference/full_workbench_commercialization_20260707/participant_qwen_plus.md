...
- Write exactly one output file: `runs/conference/full_workbench_commercialization_20260707/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: full_workbench_commercialization_20260707 - participant_qwen_plus`
2. `## Boundary Check`
