...
- Write exactly one output file: `runs/conference/full_workbench_commercialization_20260707/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: full_workbench_commercialization_20260707 - participant_mimo`
2. `## Boundary Check`
