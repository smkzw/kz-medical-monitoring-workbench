...
- Runner-managed report path: `runs/conference/mm_r7_slice08_carry_forward_contract_20260829/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice08_carry_forward_contract_20260829_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice08_carry_forward_contract_20260829.md`
...
Objective:
独立挑战 R7 Slice-08 v0.1 三模式跨 Run 连续性合同；核查医学决定版本、风险身份与转移、carry-forward、固定总量、原子发布、中文用户投影及 synthetic 边界，给出 ACCEPT 或逐条可执行 REVISE。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice08_carry_forward_contract_20260829 - general_single_object`
2. `## Boundary Check`
