...
- Write exactly one output file: `runs/conference/medical_writing_ctgov_pilot_v2_review_20260712/general_opencode_mimo.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Task:
Independently audit deterministic replay, source/version lineage, query pagination, genericity, security limits and failure paths. Distinguish pilot-acceptable behavior from production blockers.

Output schema:
1. `# Conference Participant Output: medical_writing_ctgov_pilot_v2_review_20260712 - general_opencode_mimo`
2. `## Boundary Check`
