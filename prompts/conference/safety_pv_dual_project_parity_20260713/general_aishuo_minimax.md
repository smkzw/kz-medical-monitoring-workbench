...
- Write exactly one output file: `runs/conference/safety_pv_dual_project_parity_20260713/general_aishuo_minimax.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Task:
Independently challenge the dual-project architecture and evidence boundaries. Focus on project-agnostic single/double-header parsing, CM versus investigational-product separation, source drift, five-action state transitions, durable audit and the boundary between a medical-manager collaboration workbench and a formal PV system. Do not edit files or run tests.

Output schema:
1. `# Conference Participant Output: safety_pv_dual_project_parity_20260713 - general_aishuo_minimax`
2. `## Boundary Check`
