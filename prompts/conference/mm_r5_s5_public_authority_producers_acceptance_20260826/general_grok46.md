...
- The runner-managed report path is `runs/conference/mm_r5_s5_public_authority_producers_acceptance_20260826/general_grok46.md`. Do not write that file with tools; return the complete report and let the runner persist it.
