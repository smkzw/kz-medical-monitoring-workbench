...
- Runner-managed report path: `runs/conference/mm_r8_gate3_notification_contract_review_20260831/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r8_gate3_notification_contract_review_20260831_conference_context.md`
- `plans/codex_main_venue_mm_r8_gate3_notification_contract_review_20260831.md`
...
Objective:
独立审阅 R8 G3 离页通知决策合同 v0.1：逐项挑战 Path A/B 语义、三元身份、终态保留、幂等、权限降级、点击无启动副作用、中文可行动文案及 G4/G5/G6 边界；只读 synthetic/offline 合同，不运行服务/浏览器/模型/真实项目。
...
Output schema:
1. `# Conference Participant Output: mm_r8_gate3_notification_contract_review_20260831 - general_single_object`
2. `## Boundary Check`
