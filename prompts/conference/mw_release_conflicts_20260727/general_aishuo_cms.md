...
- Runner-managed report path: `runs/conference/mw_release_conflicts_20260727/general_aishuo_cms.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: mw_release_conflicts_20260727 - general_aishuo_cms`
2. `## Boundary Check`
