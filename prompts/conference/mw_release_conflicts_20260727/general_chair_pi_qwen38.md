...
- Runner-managed report path: `runs/conference/mw_release_conflicts_20260727/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/mw_release_conflicts_20260727_conference_context.md`
- `plans/codex_main_venue_mw_release_conflicts_20260727.md`
- `runs/conference/mw_release_conflicts_20260727/general_aishuo_cms.md`
- `runs/conference/mw_release_conflicts_20260727/general_codebuddy_deepseek_pro.md`
...
Objective:
只审阅医学写作上线前四项冲突风险：隔离clean receipt、旧12-lane资产干扰、六份摘要夹具边界、DOCX门及四模型启动顺序；不得重扫产品或修改产物
...
Output schema:
1. `# Sub-Venue Review: mw_release_conflicts_20260727 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
