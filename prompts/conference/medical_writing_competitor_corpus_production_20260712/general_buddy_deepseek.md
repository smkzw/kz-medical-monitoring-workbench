...
- Write exactly one output file: `runs/conference/medical_writing_competitor_corpus_production_20260712/general_buddy_deepseek.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Task:
Independently review medical/regulatory Chinese translation governance, medical/statistical approval, evidence fidelity, source-constrained writing revision and the user-visible distinction between pending and approved content. Recommend an implementation sequence that reaches usable functionality rather than stopping at research.

Output schema:
1. `# Conference Participant Output: medical_writing_competitor_corpus_production_20260712 - general_buddy_deepseek`
2. `## Boundary Check`
