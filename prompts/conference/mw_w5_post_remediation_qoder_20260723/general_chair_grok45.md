...
- Runner-managed report path: `runs/conference/mw_w5_post_remediation_qoder_20260723/general_chair_grok45.md`. Never invoke write/edit tools
...
Initial read set:
- `AGENTS.md`
- `context/mw_w5_post_remediation_qoder_20260723_conference_context.md`
- `plans/codex_main_venue_mw_w5_post_remediation_qoder_20260723.md`
- `runs/conference/mw_w5_post_remediation_qoder_20260723/general_aishuo_cms.md`
- `runs/conference/mw_w5_post_remediation_qoder_20260723/general_opencode_deepseek_flash.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
Read-only independent audit of current W5 durable medical-writing recovery implementation before product-AI E3
...
Output schema:
1. `# Hermes Sub-Venue Review: mw_w5_post_remediation_qoder_20260723 - general_chair_grok45`
2. `## Inputs Reviewed`
