...
- Runner-managed report path: `runs/conference/mw_w5_post_remediation_qoder_20260723/general_opencode_deepseek_flash.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_w5_post_remediation_qoder_20260723 - general_opencode_deepseek_flash`
2. `## Boundary Check`
