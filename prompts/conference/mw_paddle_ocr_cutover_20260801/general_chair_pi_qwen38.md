...
- Runner-managed report path: `runs/conference/mw_paddle_ocr_cutover_20260801/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/mw_paddle_ocr_cutover_20260801_conference_context.md`
- `plans/codex_main_venue_mw_paddle_ocr_cutover_20260801.md`
- `runs/conference/mw_paddle_ocr_cutover_20260801/general_codex_luna.md`
...
Output schema:
1. `# Sub-Venue Review: mw_paddle_ocr_cutover_20260801 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
