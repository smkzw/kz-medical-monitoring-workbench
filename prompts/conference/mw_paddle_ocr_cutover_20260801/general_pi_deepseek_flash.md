...
- Runner-managed report path: `runs/conference/mw_paddle_ocr_cutover_20260801/general_pi_deepseek_flash.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Objective:
只读反证审阅医学写作 PaddleOCR-VL-1.6 文件级切换、429退避并发与回退审计合同
...
Output schema:
1. `# Conference Participant Output: mw_paddle_ocr_cutover_20260801 - general_pi_deepseek_flash`
2. `## Boundary Check`
