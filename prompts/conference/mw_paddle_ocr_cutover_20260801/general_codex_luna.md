...
- Do not write the runner-managed report path `runs/conference/mw_paddle_ocr_cutover_20260801/general_codex_luna.md`; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: mw_paddle_ocr_cutover_20260801 - general_codex_luna`
2. `## Boundary Check`
