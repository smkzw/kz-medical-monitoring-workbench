...
- Write exactly one output file: `runs/conference/monitoring_source_fragment_visual_qc_20260713/visual_opencode_qwen.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: monitoring_source_fragment_visual_qc_20260713 - visual_opencode_qwen`
2. `## Boundary Check`
