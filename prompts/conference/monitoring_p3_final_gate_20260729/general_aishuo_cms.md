...
- Runner-managed report path: `runs/conference/monitoring_p3_final_gate_20260729/general_aishuo_cms.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: monitoring_p3_final_gate_20260729 - general_aishuo_cms`
2. `## Boundary Check`
