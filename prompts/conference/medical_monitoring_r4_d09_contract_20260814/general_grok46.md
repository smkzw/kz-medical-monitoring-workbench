...
- Runner-managed report path: `runs/conference/medical_monitoring_r4_d09_contract_20260814/general_grok46.md`. Never invoke write/edit tools
...
Role emphasis: act as an adversarial data-contract and graph-workflow engineer. Propose typed identities, numerator/denominator/coverage ledgers, cutoff/window/stratum comparability, lineage and visibility contracts for D09. Attack Cartesian aggregation, duplicate revision counting, denominator drift, hidden evidence leakage, hash/order nondeterminism, rule-change-as-data-change, hard-coded thresholds, fixture/oracle coupling and D09/D10 owner leakage. Give a challenge-matrix plan with deterministic non-LLM acceptance anchors.
...
Output schema:
1. `# Conference Participant Output: medical_monitoring_r4_d09_contract_20260814 - general_grok46`
2. `## Boundary Check`
