...
- Runner-managed report path: `runs/conference/mm_r7_slice07c4_user_product_loop_contract_20260829/visual_single_object.md`. Never invoke write/edit tools
  to create or update this report file; return the complete report in your
  final assistant response and let the bounded runner persist it. Do not create
  sibling output files.

Initial read set:
- `context/mm_r7_slice07c4_user_product_loop_contract_20260829_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice07c4_user_product_loop_contract_20260829.md`

The initial read set is not a blanket prohibition on additional tool calls or evidence. If more context is required, obtain it with the available tools, explain why, and record what was read or changed.

Objective:
独立审查 R7 Slice-07C-4 中文产品闭环合同：重点挑战公开结果上下文桥、四步向导、历史/主动作、离页恢复、结果看板与 Patient Journey 同身份贯通、中文/桌面视觉验收；只读，不修改产品源码。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice07c4_user_product_loop_contract_20260829 - visual_single_object`
2. `## Boundary Check`
