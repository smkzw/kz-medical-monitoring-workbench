...
- Runner-managed report path: `runs/conference/mw_translation_fidelity_v26_20260718/general_aishuo_cms.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_translation_fidelity_v26_20260718 - general_aishuo_cms`
2. `## Boundary Check`
