...
- Runner-managed report path: `runs/conference/mw_translation_fidelity_v26_20260718/general_chair_grok45.md`. Never invoke write/edit tools
...
- `plans/codex_main_venue_mw_translation_fidelity_v26_20260718.md`
- `runs/conference/mw_translation_fidelity_v26_20260718/general_aishuo_cms.md`
- `runs/conference/mw_translation_fidelity_v26_20260718/general_opencode_deepseek_flash.md`
...
Objective:
审阅AD竞品方案真实Hy-MT2翻译v26的ch07/ch09忠实度阻断，区分真实错译与门禁误报，在Hy-MT2独占正文翻译且DeepSeek只做上层识别/QC/语料选取的边界下提出最小可验证修复
...
Output schema:
1. `# Hermes Sub-Venue Review: mw_translation_fidelity_v26_20260718 - general_chair_grok45`
2. `## Inputs Reviewed`
