...
- Write exactly one output file: `runs/conference/medical_writing_revision_ui_20260708/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: medical_writing_revision_ui_20260708 - participant_mimo`
2. `## Boundary Check`
