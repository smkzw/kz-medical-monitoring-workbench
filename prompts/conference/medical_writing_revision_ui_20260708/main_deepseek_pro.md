...
- Write exactly one output file: `runs/conference/medical_writing_revision_ui_20260708/main_deepseek_pro.md`.
...
- `runs/conference/medical_writing_revision_ui_20260708/hermes_lead.md`
- `reviews/codex_conference_medical_writing_revision_ui_20260708_review.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: medical_writing_revision_ui_20260708`
2. `## Inputs Reviewed`
