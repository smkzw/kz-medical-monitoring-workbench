...
- Write exactly one output file: `runs/conference/medical_writing_revision_ui_20260708/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: medical_writing_revision_ui_20260708 - participant_ds_flash`
2. `## Boundary Check`
