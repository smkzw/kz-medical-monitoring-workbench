...
- Runner-managed report path: `runs/conference/medical_monitoring_retro_roadmap_20260801/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
- `runs/conference/medical_monitoring_retro_roadmap_20260801/general_codex_luna.md`
- `runs/conference/medical_monitoring_retro_roadmap_20260801/general_pi_deepseek_flash.md`
...
Required work:
1. Compare agreements and contradictions in the code/architecture and P0-P10 evidence audits.
2. Reject claims that confuse code presence with release evidence, old ledger entries with current state, or commercial marketing claims with verified implementation.
3. Identify the five highest-consequence omissions or false-completion risks.
4. Recommend a bounded umbrella/program structure and the next executable Goal boundary, with stage and step exit gates.
5. Review whether the proposed next action preserves v9-v11, fail-closed boundaries, service-stop state, and the three-real-project release requirement.
6. Return a concise decision table for Codex: accepted finding, disputed finding, evidence needed, recommended disposition.
...
Output schema:
1. `# Sub-Venue Review: medical_monitoring_retro_roadmap_20260801 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
