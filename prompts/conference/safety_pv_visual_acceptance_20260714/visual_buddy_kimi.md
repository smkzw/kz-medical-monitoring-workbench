...
- Write exactly one output file: `runs/conference/safety_pv_visual_acceptance_20260714/visual_buddy_kimi.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: safety_pv_visual_acceptance_20260714 - visual_buddy_kimi`
2. `## Boundary Check`
