...
- Runner-managed report path: `runs/conference/mm_r6_runtime_slice_02_acceptance_20260827/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r6_runtime_slice_02_acceptance_20260827_conference_context.md`
- `plans/codex_main_venue_mm_r6_runtime_slice_02_acceptance_20260827.md`
...
Objective:
Independently audit the accepted-scope R6 slice-02 synthetic/offline report-review runtime after Codex remediation. Verify contract fidelity, coverage_closed versus full_report_reviewed_eligible, many-to-many identity and reverse omission mapping, tamper/overfit/fail-closed behavior, frozen slice-01 and medical-writing boundaries, exact test evidence, and identify any blocking defects. Do not modify files and do not claim product or medical acceptance.
...
Output schema:
1. `# Conference Participant Output: mm_r6_runtime_slice_02_acceptance_20260827 - general_pi_antigravity`
2. `## Boundary Check`
