...
- Write exactly one output file: `runs/conference/rux_p0_backend_review_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: rux_p0_backend_review_20260708 - participant_qwen_plus`
2. `## Boundary Check`
