...
- Write exactly one output file: `runs/conference/rux_p0_backend_review_20260708/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: rux_p0_backend_review_20260708 - participant_mimo`
2. `## Boundary Check`
