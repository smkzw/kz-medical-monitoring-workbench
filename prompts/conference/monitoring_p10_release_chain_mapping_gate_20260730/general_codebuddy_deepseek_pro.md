...
- Do not write the runner-managed report path `runs/conference/monitoring_p10_release_chain_mapping_gate_20260730/general_codebuddy_deepseek_pro.md`; return the complete report for the runner.
...
Output schema:
1. `# Conference Participant Output: monitoring_p10_release_chain_mapping_gate_20260730 - general_codebuddy_deepseek_pro`
2. `## Boundary Check`
