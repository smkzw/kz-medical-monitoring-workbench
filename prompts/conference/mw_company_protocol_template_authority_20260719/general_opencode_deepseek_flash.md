...
- Runner-managed report path: `runs/conference/mw_company_protocol_template_authority_20260719/general_opencode_deepseek_flash.md`. Never invoke write/edit tools
...
Task:
Run an independent whole-workflow pass for your assigned role. Do not look at other participant outputs. Audit the evidence matrix against the current code. Focus on clinical-writing information architecture, synopsis table semantics, conditional section selection, source authority traceability, and fail-closed behavior when facts are missing. Propose a concrete contract, migration plan, and tests. Produce findings, risks, verification needs, and bounded questions for Codex or the assigned chair.
...
Output schema:
1. `# Conference Participant Output: mw_company_protocol_template_authority_20260719 - general_opencode_deepseek_flash`
2. `## Boundary Check`
