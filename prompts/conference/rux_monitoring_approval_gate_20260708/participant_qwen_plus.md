...
- Write exactly one output file: `runs/conference/rux_monitoring_approval_gate_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: rux_monitoring_approval_gate_20260708 - participant_qwen_plus`
2. `## Boundary Check`
