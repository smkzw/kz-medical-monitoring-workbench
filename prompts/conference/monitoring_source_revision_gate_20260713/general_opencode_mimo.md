...
- Write exactly one output file: `runs/conference/monitoring_source_revision_gate_20260713/general_opencode_mimo.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Task:
Independently produce a concrete code-scoped implementation and test plan for the proposed gate. Challenge performance, concurrency, cache invalidation, API compatibility and test runtime. Do not edit files or run tests.

Output schema:
1. `# Conference Participant Output: monitoring_source_revision_gate_20260713 - general_opencode_mimo`
2. `## Boundary Check`
