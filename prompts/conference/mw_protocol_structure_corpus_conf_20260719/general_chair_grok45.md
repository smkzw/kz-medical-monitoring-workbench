...
- Runner-managed report path: `runs/conference/mw_protocol_structure_corpus_conf_20260719/general_chair_grok45.md`. Never invoke write/edit tools
...
Output schema:
1. `# Hermes Sub-Venue Review: mw_protocol_structure_corpus_conf_20260719 - general_chair_grok45`
2. `## Inputs Reviewed`
