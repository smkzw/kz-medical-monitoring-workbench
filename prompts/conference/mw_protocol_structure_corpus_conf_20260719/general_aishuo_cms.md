...
- Runner-managed report path: `runs/conference/mw_protocol_structure_corpus_conf_20260719/general_aishuo_cms.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: mw_protocol_structure_corpus_conf_20260719 - general_aishuo_cms`
2. `## Boundary Check`
