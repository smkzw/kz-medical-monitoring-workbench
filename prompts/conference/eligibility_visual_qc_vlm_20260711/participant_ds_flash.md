...
- Write exactly one output file: `runs/conference/eligibility_visual_qc_vlm_20260711/participant_ds_flash.md`.
...
Task:
Run an independent whole-workflow architecture pass. Emphasize minimal schema/API state machines, CAS/idempotency, effective projection under source/extraction/model drift and production migration risk. Do not look at other participant outputs.

Output schema:
1. `# Conference Participant Output: eligibility_visual_qc_vlm_20260711 - participant_ds_flash`
2. `## Boundary Check`
