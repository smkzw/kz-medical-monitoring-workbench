...
- Write exactly one output file: `runs/conference/full_medical_workbench_commercialization_20260708/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: full_medical_workbench_commercialization_20260708 - participant_mimo`
2. `## Boundary Check`
