...
- Write exactly one output file: `runs/conference/full_medical_workbench_commercialization_20260708/main_deepseek_pro.md`.
...
- `runs/conference/full_medical_workbench_commercialization_20260708/participant_qwen_plus.md`
- `runs/conference/full_medical_workbench_commercialization_20260708/participant_mimo.md`
- `runs/conference/full_medical_workbench_commercialization_20260708/participant_ds_flash.md`
- `runs/conference/full_medical_workbench_commercialization_20260708/hermes_lead.md`
- `reviews/codex_conference_full_medical_workbench_commercialization_20260708_review.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: full_medical_workbench_commercialization_20260708`
2. `## Inputs Reviewed`
