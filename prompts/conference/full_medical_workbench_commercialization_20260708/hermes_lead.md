...
- Write exactly one output file: `runs/conference/full_medical_workbench_commercialization_20260708/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: full_medical_workbench_commercialization_20260708 - hermes_lead`
2. `## Inputs Reviewed`
