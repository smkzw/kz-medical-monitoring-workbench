...
- Runner-managed report path: `runs/conference/mm_r6_runtime_slice_07_agent_harness_acceptance_20260828/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r6_runtime_slice_07_agent_harness_acceptance_20260828_conference_context.md`
- `plans/codex_main_venue_mm_r6_runtime_slice_07_agent_harness_acceptance_20260828.md`
...
Objective:
独立挑战并判定 R6 slice-07 Agent Harness adapter 是否满足 limited acceptance，重点检查身份绑定、coverage fail-closed、命令/NDJSON/路径/fallback/凭据与证据声明
...
Output schema:
1. `# Conference Participant Output: mm_r6_runtime_slice_07_agent_harness_acceptance_20260828 - general_pi_antigravity`
2. `## Boundary Check`
