...
- Runner-managed report path: `runs/conference/medical_monitoring_r4_d07_oracle_adjudication_20260814/general_grok45.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: medical_monitoring_r4_d07_oracle_adjudication_20260814 - general_grok45`
2. `## Boundary Check`
