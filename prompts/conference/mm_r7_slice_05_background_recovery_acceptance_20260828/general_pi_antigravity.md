...
- Runner-managed report path: `runs/conference/mm_r7_slice_05_background_recovery_acceptance_20260828/general_pi_antigravity.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice_05_background_recovery_acceptance_20260828_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice_05_background_recovery_acceptance_20260828.md`
...
Objective:
Independently audit R7 Slice-05 synthetic/offline background execution and interruption recovery against the frozen contract and current filesystem; identify concrete P0-P4 defects, boundary violations, missing concurrency/recovery tests, product-language leakage, and accept only evidence-backed behavior. Do not edit files, start services/models, or run real projects.
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice_05_background_recovery_acceptance_20260828 - general_pi_antigravity`
2. `## Boundary Check`
