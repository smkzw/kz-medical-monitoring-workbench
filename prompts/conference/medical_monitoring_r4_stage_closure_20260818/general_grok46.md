...
- Runner-managed report path: `runs/conference/medical_monitoring_r4_stage_closure_20260818/general_grok46.md`. Never invoke write/edit tools
...
Output schema:
1. `# Conference Participant Output: medical_monitoring_r4_stage_closure_20260818 - general_grok46`
2. `## Boundary Check`
