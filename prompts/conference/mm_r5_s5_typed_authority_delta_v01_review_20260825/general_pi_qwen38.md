...
- Runner-managed report path: `runs/conference/mm_r5_s5_typed_authority_delta_v01_review_20260825/general_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: mm_r5_s5_typed_authority_delta_v01_review_20260825 - general_pi_qwen38`
2. `## Boundary Check`
