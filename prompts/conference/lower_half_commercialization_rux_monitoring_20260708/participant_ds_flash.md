...
- Write exactly one output file: `runs/conference/lower_half_commercialization_rux_monitoring_20260708/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: lower_half_commercialization_rux_monitoring_20260708 - participant_ds_flash`
2. `## Boundary Check`
