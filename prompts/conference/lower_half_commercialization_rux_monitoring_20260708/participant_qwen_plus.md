...
- Write exactly one output file: `runs/conference/lower_half_commercialization_rux_monitoring_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: lower_half_commercialization_rux_monitoring_20260708 - participant_qwen_plus`
2. `## Boundary Check`
