...
Hard boundaries:
- Work only inside the current task workspace `.` and respect the declared read set.
...
- Do not write the runner-managed report path `runs/conference/mw_v035_release_conflict_20260727/general_codebuddy_deepseek_pro.md`; return the complete report for the runner.
...
Output schema:
1. `# Conference Participant Output: mw_v035_release_conflict_20260727 - general_codebuddy_deepseek_pro`
2. `## Boundary Check`
