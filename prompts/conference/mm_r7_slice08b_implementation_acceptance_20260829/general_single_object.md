...
- Runner-managed report path: `runs/conference/mm_r7_slice08b_implementation_acceptance_20260829/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice08b_implementation_acceptance_20260829_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice08b_implementation_acceptance_20260829.md`
...
Objective:
独立只读验收 R7 Slice-08B 权威与产物桥接实现，对照冻结 v0.1+v0.2 合同审查真实源码、测试与失败关闭边界；重点挑战 synthetic 身份泄漏、R1/R5/R6 复用、四输出/成员闭包/摘要/CAS/迁移/篡改阻断；只给 ACCEPT 或 REVISE 及可复现证据，不修改文件、不启动服务或真实项目。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice08b_implementation_acceptance_20260829 - general_single_object`
2. `## Boundary Check`
