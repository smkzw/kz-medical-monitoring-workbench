...
- Do not write the runner-managed report path `runs/conference/mm_r7_slice08c3_contract_20260829/general_single_object.md`; return the complete report for the runner.
...
Objective:
独立只读挑战并验收R7 Slice-08C-3 Patient Journey变化标记与详情抽屉最小实施合同；关闭P0-P2后才允许实现
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice08c3_contract_20260829 - general_single_object`
2. `## Boundary Check`
