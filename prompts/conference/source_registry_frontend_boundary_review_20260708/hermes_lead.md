...
- Write exactly one output file: `runs/conference/source_registry_frontend_boundary_review_20260708/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: source_registry_frontend_boundary_review_20260708 - hermes_lead`
2. `## Inputs Reviewed`
