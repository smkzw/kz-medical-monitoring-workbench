...
- Write exactly one output file: `runs/conference/source_registry_frontend_boundary_review_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: source_registry_frontend_boundary_review_20260708 - participant_qwen_plus`
2. `## Boundary Check`
