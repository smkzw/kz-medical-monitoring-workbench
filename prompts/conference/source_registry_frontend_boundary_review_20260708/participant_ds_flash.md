...
- Write exactly one output file: `runs/conference/source_registry_frontend_boundary_review_20260708/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: source_registry_frontend_boundary_review_20260708 - participant_ds_flash`
2. `## Boundary Check`
