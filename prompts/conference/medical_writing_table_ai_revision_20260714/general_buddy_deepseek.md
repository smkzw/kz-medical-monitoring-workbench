...
- Write exactly one output file: `runs/conference/medical_writing_table_ai_revision_20260714/general_buddy_deepseek.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: medical_writing_table_ai_revision_20260714 - general_buddy_deepseek`
2. `## Boundary Check`
