...
- Runner-managed report path: `runs/conference/mw-r14-triage-parent-timeout/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Sub-Venue Review: mw-r14-triage-parent-timeout - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
