...
- Write exactly one output file: `runs/conference/medical_writing_workspace_usability_20260715/visual_aishuo_minimax_followup.md`. The runner persists your response there; do not create sibling files.
...
Output schema:
1. `# Targeted Visual Follow-up - MiniMax-M3`
2. `## Boundary Check`
