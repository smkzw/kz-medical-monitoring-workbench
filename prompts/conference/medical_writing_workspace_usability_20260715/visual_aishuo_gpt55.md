...
- Write exactly one output file: `runs/conference/medical_writing_workspace_usability_20260715/visual_aishuo_gpt55.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: medical_writing_workspace_usability_20260715 - visual_aishuo_gpt55`
2. `## Boundary Check`
