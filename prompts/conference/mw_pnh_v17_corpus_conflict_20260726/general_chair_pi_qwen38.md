...
- Runner-managed report path: `runs/conference/mw_pnh_v17_corpus_conflict_20260726/general_chair_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `AGENTS.md`
- `context/mw_pnh_v17_corpus_conflict_20260726_conference_context.md`
- `plans/codex_main_venue_mw_pnh_v17_corpus_conflict_20260726.md`
- `runs/conference/mw_pnh_v17_corpus_conflict_20260726/general_aishuo_cms.md`
- `runs/conference/mw_pnh_v17_corpus_conflict_20260726/general_codebuddy_deepseek_pro.md`
...
Objective:
仅审查PNH v17完整condition修复、文档校验用户权限边界、语料适应症特异类型化集成的冲突和残余风险，不重复全量审计
...
Output schema:
1. `# Sub-Venue Review: mw_pnh_v17_corpus_conflict_20260726 - general_chair_pi_qwen38`
2. `## Inputs Reviewed`
