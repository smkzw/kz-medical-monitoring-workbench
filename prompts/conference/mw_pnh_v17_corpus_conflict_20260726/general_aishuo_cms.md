...
- Runner-managed report path: `runs/conference/mw_pnh_v17_corpus_conflict_20260726/general_aishuo_cms.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: mw_pnh_v17_corpus_conflict_20260726 - general_aishuo_cms`
2. `## Boundary Check`
