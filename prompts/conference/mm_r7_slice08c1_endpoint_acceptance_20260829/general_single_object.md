...
- Runner-managed report path: `runs/conference/mm_r7_slice08c1_endpoint_acceptance_20260829/general_single_object.md`. Never write that report path with tools; return the complete report and let the runner persist it.

Initial read set:
- `context/mm_r7_slice08c1_endpoint_acceptance_20260829_conference_context.md`
- `plans/codex_main_venue_mm_r7_slice08c1_endpoint_acceptance_20260829.md`
...
Objective:
独立验收Slice-08C-1中文连续性公开DTO与GET continuity端点：依据冻结v0.1+v0.2合同审查当前源码和测试，重点判断发布计划唯一投影来源、严格身份/摘要/闭集/计数/排序/fail-closed、是否仍存在worker测试污染或绕过；只读，不启动服务浏览器真实项目，不修改文件，输出ACCEPT或REVISE及精确证据。
...
Output schema:
1. `# Conference Participant Output: mm_r7_slice08c1_endpoint_acceptance_20260829 - general_single_object`
2. `## Boundary Check`
