...
- Write exactly one output file: `runs/conference/medical_writing_ctgov_corpus_20260711/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: medical_writing_ctgov_corpus_20260711 - participant_mimo`
2. `## Boundary Check`
