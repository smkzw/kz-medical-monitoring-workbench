...
- Write exactly one output file: `runs/conference/eligibility_vlm_gateway_v01_20260711/participant_ds_flash.md`.
...
Output schema:
1. `# Conference Participant Output: eligibility_vlm_gateway_v01_20260711 - participant_ds_flash`
2. `## Boundary Check`
