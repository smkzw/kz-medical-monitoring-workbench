...
- Write exactly one output file: `runs/conference/prior_work_rux_preflight_review_20260708/participant_mimo.md`.
...
Output schema:
1. `# Conference Participant Output: prior_work_rux_preflight_review_20260708 - participant_mimo`
2. `## Boundary Check`
