...
- Write exactly one output file: `runs/conference/prior_work_rux_preflight_review_20260708/main_deepseek_pro.md`.
...
- `runs/conference/prior_work_rux_preflight_review_20260708/participant_qwen_plus.md`
- `runs/conference/prior_work_rux_preflight_review_20260708/participant_mimo.md`
- `runs/conference/prior_work_rux_preflight_review_20260708/participant_ds_flash.md`
- `runs/conference/prior_work_rux_preflight_review_20260708/hermes_lead.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: prior_work_rux_preflight_review_20260708`
2. `## Inputs Reviewed`
