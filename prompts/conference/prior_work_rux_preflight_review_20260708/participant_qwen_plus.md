...
- Write exactly one output file: `runs/conference/prior_work_rux_preflight_review_20260708/participant_qwen_plus.md`.
...
Output schema:
1. `# Conference Participant Output: prior_work_rux_preflight_review_20260708 - participant_qwen_plus`
2. `## Boundary Check`
