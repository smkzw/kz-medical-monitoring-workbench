...
- Write exactly one output file: `runs/conference/prior_work_rux_preflight_review_20260708/hermes_lead.md`.
...
Output schema:
1. `# Hermes Sub-Venue Review: prior_work_rux_preflight_review_20260708 - hermes_lead`
2. `## Inputs Reviewed`
