...
- Runner-managed report path: `runs/conference/medical_monitoring_r4_d03_stable_acceptance_20260811/general_pi_qwen38.md`. Never write that report path with tools; return the complete report and let the runner persist it.
...
Output schema:
1. `# Conference Participant Output: medical_monitoring_r4_d03_stable_acceptance_20260811 - general_pi_qwen38`
2. `## Boundary Check`
