...
- Write exactly one output file: `runs/conference/medical_writing_word_table_visual_20260714/visual_opencode_qwen.md`. The bounded runner persists your final response there; do not create sibling output files.
...
Output schema:
1. `# Conference Participant Output: medical_writing_word_table_visual_20260714 - visual_opencode_qwen`
2. `## Boundary Check`
