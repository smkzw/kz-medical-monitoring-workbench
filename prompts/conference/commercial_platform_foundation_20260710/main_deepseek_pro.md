...
- Write exactly one output file: `runs/conference/commercial_platform_foundation_20260710/main_deepseek_pro.md`.
...
- `runs/conference/commercial_platform_foundation_20260710/participant_qwen_plus.md`
- `runs/conference/commercial_platform_foundation_20260710/participant_mimo.md`
- `runs/conference/commercial_platform_foundation_20260710/participant_ds_flash.md`
- `runs/conference/commercial_platform_foundation_20260710/participant_buddy_minimax.md`
- `runs/conference/commercial_platform_foundation_20260710/participant_glm52_product.md`
- `runs/conference/commercial_platform_foundation_20260710/hermes_lead.md`
- `reviews/codex_conference_commercial_platform_foundation_20260710_review.md`
- `metrics/commercial_platform_foundation_20260710_conference_metrics.md`
...
Output schema:
1. `# Main-Venue DeepSeek Pro Review: commercial_platform_foundation_20260710`
2. `## Inputs Reviewed`
