...
- Runner-managed output path: `runs/codex_mw_candidate_fact_state_trace_20260719.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_candidate_fact_state_trace_20260719_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_candidate_fact_state_trace_20260719`
2. `## Boundary Check`
3. `## Direct Work`
