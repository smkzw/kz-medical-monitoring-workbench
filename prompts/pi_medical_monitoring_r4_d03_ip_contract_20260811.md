...
- Runner-managed output path: `runs/pi_medical_monitoring_r4_d03_ip_contract_20260811.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: medical_monitoring_r4_d03_ip_contract_20260811`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
