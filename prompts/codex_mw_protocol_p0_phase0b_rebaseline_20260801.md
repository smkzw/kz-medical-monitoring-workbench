...
- Runner-managed output path: `runs/codex_mw_protocol_p0_phase0b_rebaseline_20260801.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: mw_protocol_p0_phase0b_rebaseline_20260801`
2. `## Boundary Check`
3. `## Direct Work`
