...
- Write exactly one output file: `runs/hermes_patient_profile_page_v10_step.md`.

Read these files only:
- `context/patient_profile_page_v10_step_context.md`
...
Output schema:
1. `# Hermes Task Plan: patient_profile_page_v10_step`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
