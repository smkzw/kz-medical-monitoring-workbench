...
- Runner-managed output path: `runs/pi_mw_protocol_p0_phase0b_runtime_draft_word_20260801.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: mw_protocol_p0_phase0b_runtime_draft_word_20260801`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
