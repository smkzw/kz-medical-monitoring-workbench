...
- Runner-managed output path: `runs/codex_medical_monitoring_r1_attempt_isolation_20260809.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_r1_attempt_isolation_20260809`
2. `## Boundary Check`
3. `## Direct Work`
