...
- Runner-managed output path: `runs/hermes_medical_monitoring_p5.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_p5_context.md`
...
Output schema:
1. `# Hermes Task Plan: medical_monitoring_p5`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
