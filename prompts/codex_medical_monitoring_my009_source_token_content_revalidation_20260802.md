...
- Runner-managed output path: `runs/codex_medical_monitoring_my009_source_token_content_revalidation_20260802.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_my009_source_token_content_revalidation_20260802_context.md`
...
Do not turn a filename, workbook shape, matching meaning token, or lack of a
raw byte hit into provenance proof. Preserve `not_proven` unless direct,
source-bound evidence exists.

Output schema:
1. `# Codex Direct Task: medical_monitoring_my009_source_token_content_revalidation_20260802`
2. `## Boundary Check`
3. `## Direct Work`
