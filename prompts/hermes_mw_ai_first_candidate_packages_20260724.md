...
- Runner-managed output path: `runs/hermes_mw_ai_first_candidate_packages_20260724.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: mw_ai_first_candidate_packages_20260724`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
