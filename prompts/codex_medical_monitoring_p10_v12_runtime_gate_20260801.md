...
- Runner-managed output path: `runs/codex_medical_monitoring_p10_v12_runtime_gate_20260801.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_p10_v12_runtime_gate_20260801`
2. `## Boundary Check`
3. `## Direct Work`
