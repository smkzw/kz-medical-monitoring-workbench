...
- Write exactly one output file: `runs/hermes_evidence_design_manifest_20260708.md`.

Read these files only:
- `context/evidence_design_manifest_20260708_context.md`
...
Output schema:
1. `# Hermes Task Plan: evidence_design_manifest_20260708`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
