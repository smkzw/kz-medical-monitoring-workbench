...
- Runner-managed output path: `runs/codex_medical_monitoring_daily_run_digest_shape_revalidation_20260805.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/medical_monitoring_daily_run_digest_shape_revalidation_20260805_context.md`
...
Present daily-run SHA-256 values must be validated as exact lowercase 64-hex
strings without strip/lower rewriting. Preserve intentional optional empty
values and current lifecycle/CAS behavior. Add focused regressions for padded,
uppercase, malformed, short and non-string inputs.
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_daily_run_digest_shape_revalidation_20260805`
2. `## Boundary Check`
3. `## Direct Work`
