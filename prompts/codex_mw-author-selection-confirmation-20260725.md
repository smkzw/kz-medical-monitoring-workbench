...
- Runner-managed output path: `runs/codex_mw-author-selection-confirmation-20260725.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: mw-author-selection-confirmation-20260725`
2. `## Boundary Check`
3. `## Direct Work`
