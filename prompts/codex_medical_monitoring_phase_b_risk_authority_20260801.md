...
- Runner-managed output path: `runs/codex_medical_monitoring_phase_b_risk_authority_20260801.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_phase_b_risk_authority_20260801`
2. `## Boundary Check`
3. `## Direct Work`
