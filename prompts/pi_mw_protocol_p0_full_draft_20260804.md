...
- Runner-managed output path: `runs/pi_mw_protocol_p0_full_draft_20260804.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_protocol_p0_full_draft_20260804_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_protocol_p0_full_draft_20260804`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
