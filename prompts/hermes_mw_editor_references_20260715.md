...
- Write exactly one output file: `runs/hermes_mw_editor_references_20260715.md`.

Read these files only:
- `context/mw_editor_references_20260715_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_editor_references_20260715`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
