...
- Runner-managed output path: `runs/codex_qwen38_local_provider_integration_20260726.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/qwen38_local_provider_integration_20260726_context.md`
...
Output schema:
1. `# Codex Direct Task: qwen38_local_provider_integration_20260726`
2. `## Boundary Check`
3. `## Direct Work`
