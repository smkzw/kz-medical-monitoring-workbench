...
- Runner-managed output path: `runs/hermes_provider_selector_research_20260726.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/provider_selector_research_20260726_context.md`
...
Output schema:
1. `# Hermes Task Plan: provider_selector_research_20260726`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
