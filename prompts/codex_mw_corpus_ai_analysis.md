...
- Runner-managed output path: `runs/codex_mw_corpus_ai_analysis.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_corpus_ai_analysis_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_corpus_ai_analysis`
2. `## Boundary Check`
3. `## Direct Work`
