...
- Write exactly one output file: `runs/hermes_medical_workbench_source_registry.md`.

Read these files only:
- `context/medical_workbench_source_registry_context.md`
...
Output schema:
1. `# Hermes Task Plan: medical_workbench_source_registry`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
