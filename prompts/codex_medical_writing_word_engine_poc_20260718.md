...
- Write exactly one output file: `runs/codex_medical_writing_word_engine_poc_20260718.md`.

Read these files only:
- `context/medical_writing_word_engine_poc_20260718_context.md`
...
Output schema:
1. `# Codex Direct Task: medical_writing_word_engine_poc_20260718`
2. `## Boundary Check`
3. `## Direct Work`
