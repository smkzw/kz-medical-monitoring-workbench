...
- Runner-managed output path: `runs/codex_mw-real-translation-protocol-20260726.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-real-translation-protocol-20260726_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-real-translation-protocol-20260726`
2. `## Boundary Check`
3. `## Direct Work`
