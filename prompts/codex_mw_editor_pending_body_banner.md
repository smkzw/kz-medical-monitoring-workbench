...
- Runner-managed output path: `runs/codex_mw_editor_pending_body_banner.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_editor_pending_body_banner_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_editor_pending_body_banner`
2. `## Boundary Check`
3. `## Direct Work`
