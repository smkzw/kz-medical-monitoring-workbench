...
- Runner-managed output path: `runs/pi_medical_monitoring_risk_source_token_shape_20260802.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: medical_monitoring_risk_source_token_shape_20260802`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
