...
- Runner-managed output path: `runs/pi_release-r10-20260728-a1-lazy-e2e.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/release-r10-20260728-a1-lazy-e2e_context.md`
...
Output schema:
1. `# Hermes Task Plan: release-r10-20260728-a1-lazy-e2e`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
