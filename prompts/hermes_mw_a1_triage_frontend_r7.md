...
- Runner-managed output path: `runs/hermes_mw_a1_triage_frontend_r7.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_a1_triage_frontend_r7_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_a1_triage_frontend_r7`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
