...
- Runner-managed output path: `runs/codex_monitoring_p10_runtime_resume_cache_20260730.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/monitoring_p10_runtime_resume_cache_20260730_context.md`
...
Output schema:
1. `# Codex Direct Task: monitoring_p10_runtime_resume_cache_20260730`
2. `## Boundary Check`
3. `## Direct Work`
