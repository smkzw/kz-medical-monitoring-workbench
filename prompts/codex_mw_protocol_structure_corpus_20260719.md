...
- Runner-managed output path: `runs/codex_mw_protocol_structure_corpus_20260719.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: mw_protocol_structure_corpus_20260719`
2. `## Boundary Check`
3. `## Direct Work`
