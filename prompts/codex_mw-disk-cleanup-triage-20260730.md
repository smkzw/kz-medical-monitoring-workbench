...
- Runner-managed output path: `runs/codex_mw-disk-cleanup-triage-20260730.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-disk-cleanup-triage-20260730_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-disk-cleanup-triage-20260730`
2. `## Boundary Check`
3. `## Direct Work`
