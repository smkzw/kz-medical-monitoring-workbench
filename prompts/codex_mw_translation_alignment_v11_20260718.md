...
- Write exactly one output file: `runs/codex_mw_translation_alignment_v11_20260718.md`.

Read these files only:
- `context/mw_translation_alignment_v11_20260718_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_translation_alignment_v11_20260718`
2. `## Boundary Check`
3. `## Direct Work`
