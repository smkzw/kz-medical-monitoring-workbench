...
- Runner-managed output path: `runs/hermes_medical_writing_frontend_kimi_progressive_20260719.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: medical_writing_frontend_kimi_progressive_20260719`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
