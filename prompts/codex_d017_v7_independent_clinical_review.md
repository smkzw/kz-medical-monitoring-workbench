...
- Runner-managed output path: `runs/codex_d017_v7_independent_clinical_review.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/d017_v7_independent_clinical_review_context.md`
...
Output schema:
1. `# Codex Direct Task: d017_v7_independent_clinical_review`
2. `## Boundary Check`
3. `## Direct Work`
