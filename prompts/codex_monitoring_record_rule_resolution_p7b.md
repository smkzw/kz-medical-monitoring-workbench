...
- Runner-managed output path: `runs/codex_monitoring_record_rule_resolution_p7b.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: monitoring_record_rule_resolution_p7b`
2. `## Boundary Check`
3. `## Direct Work`
