...
- Write exactly one output file: `runs/hermes_mw_translation_glossary_flash.md`.

Read these files only:
- `context/mw_translation_glossary_flash_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw_translation_glossary_flash`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
