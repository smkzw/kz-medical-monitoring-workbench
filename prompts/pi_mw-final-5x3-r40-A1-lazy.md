...
- Runner-managed output path: `runs/pi_mw-final-5x3-r40-A1-lazy.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-final-5x3-r40-A1-lazy_context.md`
...
Output schema:
1. `# Hermes Task Plan: mw-final-5x3-r40-A1-lazy`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
