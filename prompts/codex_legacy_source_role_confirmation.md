...
- Runner-managed output path: `runs/codex_legacy_source_role_confirmation.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/legacy_source_role_confirmation_context.md`
...
Output schema:
1. `# Codex Direct Task: legacy_source_role_confirmation`
2. `## Boundary Check`
3. `## Direct Work`
