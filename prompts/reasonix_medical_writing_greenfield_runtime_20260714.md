...
- Write exactly one output file: `runs/reasonix_medical_writing_greenfield_runtime_20260714.md`.

Read these files only:
- `context/medical_writing_greenfield_runtime_20260714_context.md`
...
Output schema:
1. `# Reasonix Task Plan: medical_writing_greenfield_runtime_20260714`
2. `## Boundary Check`
