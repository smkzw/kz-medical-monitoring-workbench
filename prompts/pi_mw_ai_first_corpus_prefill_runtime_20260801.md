...
- Runner-managed output path: `runs/pi_mw_ai_first_corpus_prefill_runtime_20260801.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: mw_ai_first_corpus_prefill_runtime_20260801`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
