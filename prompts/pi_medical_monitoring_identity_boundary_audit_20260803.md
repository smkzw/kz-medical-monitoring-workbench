...
- Runner-managed output path: `runs/pi_medical_monitoring_identity_boundary_audit_20260803.md`. Never invoke a
...
Output schema:
1. `# Hermes Task Plan: medical_monitoring_identity_boundary_audit_20260803`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
