...
- Runner-managed output path: `runs/codex_mw-author-selection-independent-review-20260725.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-author-selection-independent-review-20260725_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-author-selection-independent-review-20260725`
2. `## Boundary Check`
3. `## Direct Work`
