...
- Runner-managed output path: `runs/codex_mw-a1-r13-lazy-medical-writer.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-a1-r13-lazy-medical-writer_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-a1-r13-lazy-medical-writer`
2. `## Boundary Check`
3. `## Direct Work`
