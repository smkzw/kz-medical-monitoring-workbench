...
- Runner-managed output path: `runs/hermes_monitoring-v7-deterministic-repair.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/monitoring-v7-deterministic-repair_context.md`
...
Output schema:
1. `# Hermes Task Plan: monitoring-v7-deterministic-repair`
2. `## Boundary Check`
3. `## Hermes-Safe Work`
