...
- Runner-managed output path: `runs/codex_medical_monitoring_subject_prompt_evidence_shape_20260802.md`. Never invoke a
...
Output schema:
1. `# Codex Direct Task: medical_monitoring_subject_prompt_evidence_shape_20260802`
2. `## Boundary Check`
3. `## Direct Work`
