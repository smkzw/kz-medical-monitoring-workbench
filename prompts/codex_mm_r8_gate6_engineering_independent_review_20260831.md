...
- Runner-managed output path: `runs/codex_mm_r8_gate6_engineering_independent_review_20260831.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mm_r8_gate6_engineering_independent_review_20260831_context.md`
...
Output schema:
1. `# Codex Direct Task: mm_r8_gate6_engineering_independent_review_20260831`
2. `## Boundary Check`
3. `## Direct Work`
