...
- Runner-managed output path: `runs/codex_mw-d017-source-truth-v6.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw-d017-source-truth-v6_context.md`
...
Output schema:
1. `# Codex Direct Task: mw-d017-source-truth-v6`
2. `## Boundary Check`
3. `## Direct Work`
