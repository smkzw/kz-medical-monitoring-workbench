...
- Runner-managed output path: `runs/codex_mw_final_5x3_r31_a1_lazy_copd_20260729.md`. Never invoke a
  write/edit tool on this report path; return the complete report in your final
  response and let the runner persist it.

Read these files only:
- `context/mw_final_5x3_r31_a1_lazy_copd_20260729_context.md`
...
Output schema:
1. `# Codex Direct Task: mw_final_5x3_r31_a1_lazy_copd_20260729`
2. `## Boundary Check`
3. `## Direct Work`
