...
class AdmissionMappingPipeline:
    ...
    def _adjudication_prompt_version(self, cohort):
        ...
        if self._role_equivalence:
            return ("monitoring-listing-field-mapping-adjudication-verifier-v12-tools-v7.1" if verifier
                    else "monitoring-listing-field-mapping-adjudication-v14-tools-v7.1")
